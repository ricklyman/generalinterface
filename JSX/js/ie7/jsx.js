...
ub={A:"jsxtabindex",B:"alpha(opacity=",C:")",D:"filter:alpha(opacity=",E:");",F:"text",G:"jsx:///images/icons/h.png",H:"jsx:///images/icons/v.png",I:"background-image:url(",J:"_jsx_",K:"disable-output-escp",L:/&lt;/g,M:"<",N:/&gt;/g,O:">",P:/&quot;/g,Q:'"',R:/&amp;/g,S:"&",T:/&([a-zA-Z_]+);/g,U:"class",V:/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,W:"&#",X:";",Y:"jsx_image_loader",Z:"none",_:"_",a:' unselectable="on"',aa:"img",b:"overflow:hidden;",ba:"alt",c:"body",ca:"id",d:'<input type="text" id="_jsx3_html_b1" style="position:absolute;top:0px;left:-120px;width:100px;height:30px;padding:8px;margin:0px;"/>',da:"src",e:"beforeEnd",ea:"unshift",f:"_jsx3_html_b1",fa:"push",g:'<div id="_jsx3_html_b2" style="position:absolute;top:0px;left:-116px;width:100px;height:24px;padding:8px;"></div>',ga:/\//g,h:"_jsx3_html_b2",ha:/\s+/g,i:"string",ia:" ",j:/^<([^\s]*)([\s\S]*)\/>$/i,k:"<$1$2></$1>",l:"",m:"span",n:"div",o:"scroll",p:"function",q:/\-(\w)/g,r:"head",s:"undefined",t:"http://www.w3.org/1999/xhtml",u:"style",v:"type",w:"text/css",x:"media",y:"screen",z:"object"};var
...
wb=r.getRelativePosition(null,d);C=C-wb.L;Q=Q-wb.T;}else{Q=Q-i.ownerDocument.body.scrollTop;C=C-i.ownerDocument.body.scrollLeft;}}return {L:C,T:Q,W:i.offsetWidth,H:i.offsetHeight};};r.copy=function(n){window.clipboardData.setData(ub.F,n);};r.paste=function(){return window.clipboardData.getData(ub.F);};r.OG=jsx3.resolveURI(ub.G);r.R1=jsx3.resolveURI(ub.H);r.getCSSFade=function(c){return r.getCSSPNG(c?r.OG:r.R1);};r.getCSSPNG=function(n){return ub.I+n+ub.E;};r.getJSXParent=function(d,k){while(d!=null){if(d.id&&d.id.indexOf(ub.J)==0){var
va=k?k.getJSXById(d.id):jsx3.GO(d.id);if(va!=null)return va;}if(!d.parentNode){var
qb=d.parentWindow||d.defaultView;d=qb?qb.frameElement:null;}else d=d.parentNode;}return null;};r.removeOutputEscaping=function(c){var
L=c?[c]:[];while(L.length>0){var
Z=L.shift();if(Z.nodeName&&r._tn(Z)==ub.m&&Z.className==ub.K){Z.innerHTML=((((Z.innerHTML.replace(ub.L,ub.M)).replace(ub.N,ub.O)).replace(ub.P,ub.Q)).replace(ub.R,ub.S)).replace(ub.T,r.KQ);Z.removeAttribute(ub.U);}else if(Z.childNodes)L.push.apply(L,this.nodesToArray(Z.childNodes));}};r.removeOutputEscapingSpan=function(g){return g.replace(ub.V,function(p,m){return ((((m.replace(ub.L,ub.M)).replace(ub.N,ub.O)).replace(ub.P,ub.Q)).replace(ub.R,ub.S)).replace(ub.T,r.KQ);});};r.EE={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.KQ=function(f,g){var
O=r.EE[g];return O?ub.W+O+ub.X:f;};r.YN=ub.Y;r.loadImages=function(i){var
jb=document.getElementById(r.YN);if(jb==null){var
gb=(document.getElementsByTagName(ub.c))[0];if(gb){jb=document.createElement(ub.n);jb.id=r.YN;jb.style.display=ub.Z;gb.insertBefore(jb,gb.firstChild);}else return;}var
B=jsx3.$A.is(i)?i:arguments;for(var
za=0;za<B.length;za++){if(!B[za])continue;var
Ya=jsx3.resolveURI(B[za]);var
y=r.YN+ub._+Ya;if(document.getElementById(y)==null){var
Gb=document.createElement(ub.aa);Gb.setAttribute(ub.ba,ub.l);Gb.setAttribute(ub.ca,y);Gb.setAttribute(ub.da,ub.l+Ya);jb.appendChild(Gb);}}};r.updateRule=function(d,h,p){var
da=jsx3.html.getRuleByName(d);if(da)da.style[h]=p;};r.getElementById=function(s,l,g){return this.findElements(s,function(c){return c.id==l;},g,false,false,true);};r.getElementByTagName=function(a,g,h){g=g.toLowerCase();return this.findElements(a,function(k){return r._tn(k)==g;},h,false,false,true);};r.getElementsByTagName=function(d,b,k){b=b.toLowerCase();return this.findElements(d,function(h){return r._tn(h)==b;},k,true,false,true);};r.findElements=function(q,n,e,a,f,s){var
na=e?ub.ea:ub.fa;var
P=a?[]:null;var
ob=s?[q]:this.nodesToArray(q.childNodes);while(ob.length>0){var
t=ob.shift();if(n.call(null,t))if(a)P[P.length]=t;else return t;if(!f)ob[na].apply(ob,this.nodesToArray(t.childNodes));}return P;};r.getElmUpByTagName=function(k,s,d){return r.findElementUp(k,function(h){return r._tn(h)==s;},d);};r.findElementUp=function(f,o,m){var
v=f.ownerDocument.documentElement;var
Ka=m?f:f.parentNode;while(Ka!=null){if(o.call(null,Ka))return Ka;if(Ka==v)break;Ka=Ka.parentNode;}return null;};r.selectSingleElm=function(o,l){var
Fb=1,Ka=arguments;if(arguments.length==2)if(typeof l==ub.i){Fb=0;Ka=l.split(ub.ga);}else if(jsx3.$A.is(l)){Fb=0;Ka=l;}var
bb=o;for(var
fa=Fb;bb!=null&&fa<Ka.length;fa++){var
X=Ka[fa];if(!isNaN(X)){var
xa=Number(X);var
T=bb.childNodes.length;var
Kb=0,Ba=0;for(;Kb<T&&Ba<xa;Kb++)if(bb.childNodes[Kb].nodeType==1)Ba++;bb=bb.childNodes[Kb];}else throw new
jsx3.Exception();}return bb;};r.nodesToArray=function(q){var
ta=new
Array(q.length);for(var
Kb=0;Kb<q.length;Kb++)ta[Kb]=q[Kb];return ta;};r.getSelection=function(f){return new
r.Selection(f);};r.focusNext=function(i,d){var
Va=i;while(Va.lastChild)Va=Va.lastChild;while(!r.isFocusable(Va)&&Va!=i)Va=Va.previousSibling||Va.parentNode;if(Va!=i||r.isFocusable(Va))if(Va.onfocus!=null){var
Hb=Va.onfocus;Va.onfocus=null;Va.focus();jsx3.sleep(function(){Va.onfocus=Hb;});}else Va.focus();};r.focusPrevious=function(n,p){var
wa=this.findElements(n,function(h){return r.isFocusable(h);},true,false,false,true);if(wa!=null)if(wa.onfocus!=null){var
Ya=wa.onfocus;wa.onfocus=null;wa.focus();jsx3.sleep(function(){wa.onfocus=Ya;});}else wa.focus();};r.focus=function(s){try{if(s.focus)s.focus();}catch(Kb){}};r.addClass=function(b,f){var
A=b.className;if(A){if(!(jsx3.$A(A.split(ub.ha))).contains(f))b.className=A+ub.ia+f;}else b.className=f;};r.removeClass=function(c,g){var
ca=c.className;if(ca&&ca.indexOf(g)>=0){var
Za=jsx3.$A(ca.split(ub.ha));if(Za.remove(g))c.className=Za.join(ub.ia);}};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(r,l){var
ub={a:"textarea",b:"EndToEnd",c:/\r\n|\r|\n/g,d:"character",e:"end"};var
kb=jsx3.html;l.init=function(g){this.RW=(g.ownerDocument.selection.createRange()).duplicate();this.oK=g;};l.getStartIndex=function(){var
t=this.oK.ownerDocument.selection.createRange();var
wb=null;if(kb._tn(this.oK)==ub.a){wb=t.duplicate();wb.moveToElementText(this.oK);}else wb=this.oK.createTextRange();wb.setEndPoint(ub.b,t);return wb.text.length-t.text.length;};l.getEndIndex=function(){var
X=this.oK.ownerDocument.selection.createRange();var
ob=null;if(kb._tn(this.oK)==ub.a){ob=X.duplicate();ob.moveToElementText(this.oK);}else ob=this.oK.createTextRange();ob.setEndPoint(ub.b,X);return ob.text.length;};l.setRange=function(a,f){var
ja=this.oK.value;var
Mb=ub.c;Mb.lastIndex=0;var
Ka=f;while(Mb.test(ja)&&Mb.lastIndex<=Ka){a=a-1;f=f-1;}var
sa=this.oK.createTextRange();sa.collapse(true);sa.moveStart(ub.d,a);sa.moveEnd(ub.d,f-a);sa.select();};l.getOffsetLeft=function(){return this.RW.offsetLeft;};l.getOffsetTop=function(){return this.RW.offsetTop;};l.getText=function(){return this.RW.text;};l.setText=function(p){this.RW.text=p;};l.insertCaret=function(a){if(a==ub.e){this.RW.collapse();this.RW.select();}else throw new
