...
sa=this.bW.childNodes[X];if(sa.nodeType==3||sa.nodeType==4)fb[X]=sa.nodeValue;else fb[X]=sa.textContent;}return fb.join(ub.b);}else return this.bW.nodeValue;};a.setValue=function(i){if(i==null)i=ub.b;if(this.fA==1){this.removeChildren();this.appendChild(this.createNode(3,i));}else this.bW.nodeValue=i;return this;};m.JU=new
XPathEvaluator();m.RH=[XPathResult.FIRST_ORDERED_NODE_TYPE,XPathResult.ORDERED_NODE_ITERATOR_TYPE,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE];a.rt=function(l,s,i){if(typeof s==ub.k)s=jsx3.xml.Document.ao(s);var
xb=this.bW.ownerDocument;var
pb=xb.documentElement;var
la=s?m.gs(s,pb):m.C7(xb)||m.JU.createNSResolver(pb);var
B=null;try{B=m.JU.evaluate(l,this.bW,la,m.RH[i],null);}catch(Kb){}if(i==1){var
Sa=null;var
...
m(B.singleNodeValue):null;};m.C7=function(f){if(!f._jsxpd)if(f._jsxIm)f._jsxpd=m.gs(f._jsxIm);return f._jsxpd;};m.ww={};m.gs=function(k){var
ua=m.ww[k];if(!ua){var
db=(new
DOMParser()).parseFromString(ub.l+k+ub.m,ub.n);ua=m.ww[k]=m.JU.createNSResolver(db.documentElement);}return ua;};a.Kt=function(i){if(i==null){return this.bW.ownerDocument;}else if(i==1){var
...
pa=new
jsx3.xml.Template(q);if(c)pa.setParams(c);return pa[s?ub.p:ub.q](this);};m.OR=function(){};m.OR.prototype.toString=function(){return ub.r+this.code+ub.s+(typeof this.description!=ub.t?ub.u+this.description:ub.b);};a.Dk=function(k,d){if(this.dN==null)this.dN=new
m.OR();this.dN.code=k;this.dN.description=d;};a.getError=function(){if(!this.dN)this.Dk(0);return this.dN;};a.hasError=function(){return this.dN!=null&&this.dN.code!=0;};a.getOwnerDocument=function(){return this.bW?new
jsx3.xml.Document(this.Kt()):null;};m.getVersion=function(){return ub.v;};});jsx3.Entity=jsx3.xml.Entity;jsx3.Class.defineClass("jsx3.xml.Entity.List",jsx3.util.List,null,function(b,g){var
ub={a:"Not implemented",b:"[",c:"]"};var
D=jsx3.Exception;g.init=function(n){this.jsxsuper(null,true);this.aV=n;};g.get=function(s){var
Ra=this.aV[s];return Ra!=null?new
...
b(arguments.length>1?this.aV.slice(m,a):this.aV.slice(m));};g.toString=function(){return ub.b+this.toArray()+ub.c;};g.clone=function(){return new
b(this.aV.concat());};g.toArray=function(){var
Ia=this.size();var
zb=new
Array(Ia);for(var
kb=0;kb<Ia;kb++)zb[kb]=this.get(kb);return zb;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(d,h){h.init=function(e,a){this.QN=e;this.ty=0;this.Ny=a;this.i6();this.bW=null;};h.next=function(){if(!this._next)return null;if(this.bW){this.bW.init(this._next);}else this.bW=new
...
u=X[this.ty];if(u.nodeType==1||this.Ny&&(u.nodeType==3||u.nodeType==4))this._next=u;this.ty++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(f,j){j.init=function(c){this.OC=c;this.x2=0;this.bW=null;};j.next=function(){var
ta=this.OC.snapshotItem(this.x2++);if(!ta)return null;if(this.bW){this.bW.init(ta);}else this.bW=new
jsx3.xml.Entity(ta);return this.bW;};j.hasNext=function(){return this.OC&&this.x2<this.OC.snapshotLength;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(g,f){var
...
ha=false;try{if(!this.OJ)g.INSYNC=true;this._request.send(d);if(this.OJ)this.hS=0;else delete this[ub.o];}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.p,this.eE,jsx3.NativeError.wrap(Kb)));ha=this;}finally{g.INSYNC=false;}if(this.OJ)if(ha||this._request.readyState==4){jsx3.sleep(function(){this.publish({subject:ub.a});},null,this);}else{var
jb=this;this._request.onreadystatechange=function(){if(jb._request.readyState==4)if(g.INSYNC){jsx3.sleep(function(){jb.nG();});}else jb.nG();};if(!isNaN(m)&&m>0)this._timeoutto=window.setTimeout(function(){jb.LZ();},m);}return this;};f.LZ=function(){delete this[ub.d];this.abort();this.hS=408;this.publish({subject:ub.b});};f.nG=function(){delete this[ub.o];if(this._timeoutto){window.clearTimeout(this._timeoutto);delete this[ub.d];}this._request.onreadystatechange=new
Function();this.getStatusText();this.publish({subject:ub.a});};f.toString=function(){return this.jsxsuper()+ub.q+this.yT+ub.q+this.getStatus()+ub.q+this.eE;};g.Q2=function(i,e){if(g.dK==null)if(jsx3.util.Logger){g.dK=jsx3.util.Logger.getLogger(g.jsxclass.getName());if(g.dK==null)return;}else return;g.dK.log(i,e);};g.getVersion=function(){return ub.r;};});jsx3.HttpRequest=jsx3.net.Request;jsx3.Class.defineClass("jsx3.xml.Document",jsx3.xml.Entity,[jsx3.util.EventDispatcher],function(e,m){var
ub={A:"xml.unknown",B:"UniversalBrowserRead",C:"1.0",D:"<?xml",E:' version="',F:'"',G:' encoding="',H:' standalone="',I:"yes",J:"no",K:"?>\n",L:"xml",M:"<!-- ",N:" -->",O:"\n",P:"XPath",Q:"xmlns:",R:"='",S:"'",T:"object",U:"([^=]*)=['\"]([^\"^']*)['\"]",V:"g",W:":",X:"http://www.w3.org/XML/1998/namespace",Y:"undefined",Z:"jsx",_:"attribute::* | child::*",a:"response",aa:"3.0.0",b:"error",c:"timeout",d:"http://xsd.tns.tibco.com/gi/cxf/2006",e:"jsx_xmlns",f:/xmlns:([^=]*)=['\"]([^\"^']*)['\"]/g,g:"",h:"xml.parser",i:"MV",j:"GET",k:"*",l:"CY",m:"lw",n:"content-type",o:/xml|xsl/i,p:"xml.doc_status",q:"xml.timeout",r:"text/xml",s:"0",t:"xml.err_fmt",u:"xml.doc_bad_ex",v:"xml.doc_bad",w:"parsererror",x:/^http:\/\/www\.mozilla\.org\/(.+\/)?parsererror.xml/i,y:/[\n\r]/g,z:" "};var
...
T=i.target;var
Wa=i.subject;delete this[ub.m];T.unsubscribe(ub.k,this);if(Wa==ub.a){this.po(T);}else if(Wa==ub.c){this.Dk(111,jsx3._msg(ub.q));this.publish({subject:ub.c});}else e.Q2();};m.CB=function(n){Ma.prototype.init.call(this,n);};m.loadXML=function(r){this.eE=null;this.abort();try{this.MV=(new
...
I=p.documentElement;if(I==null){if(f)this.Dk(158,jsx3._msg(ub.u,f));else this.Dk(108,jsx3._msg(ub.v));return true;}else if(I.tagName==ub.w&&I.namespaceURI&&I.namespaceURI.match(ub.x)){this.Dk(109,I.textContent.replace(ub.y,ub.z));return true;}}if(f!=null){this.Dk(110,jsx3._msg(ub.A,jsx3.NativeError.wrap(f)));return true;}return false;};m.getValidateOnParse=function(){return this.MV.validateOnParse;};m.setValidateOnParse=function(p){this.MV.validateOnParse=p;};m.getResolveExternals=function(){return this.MV.resolveExternals;};m.setResolveExternals=function(o){this.MV.resolveExternals=o;};m.cloneDocument=function(){try{netscape.security.PrivilegeManager.enablePrivilege(ub.B);}catch(Kb){}try{var
Qa=new
e(this.MV.cloneNode(true));}catch(Kb){var
Qa=new
e();Qa.loadXML(this.getXML());}return Qa;};m.toString=function(){if(this.MV!=null&&!this.hasError()){return (new
XMLSerializer()).serializeToString(this.MV);}else return this.jsxsuper();};m.getXmlVersion=function(){return this.MV.xmlVersion;};m.getXmlEncoding=function(){return this.MV.xmlEncoding;};m.getXmlStandalone=function(){return this.MV.xmlStandalone;};m.serialize=function(s,q,d){if(s===true)s=this.getXmlVersion()||ub.C;if(q===true)q=this.getXmlEncoding();var
ha=s||q||d;if(ha){var
ka=ub.D;if(s)ka=ka+(ub.E+s+ub.F);if(q)ka=ka+(ub.G+q+ub.F);if(d!=null)ka=ka+(ub.H+(d?ub.I:ub.J)+ub.F);ka=ka+ub.K;var
ga=new
Array(this.MV.childNodes.length+1);ga[0]=ka;for(var
wa=0;wa<this.MV.childNodes.length;wa++){var
ja=this.MV.childNodes[wa];if(ja.nodeType!=7||ja.nodeName!=ub.L){var
sa=new
Ma(ja);ga[wa+1]=sa.hasError()?ub.M+sa+ub.N:sa.toString();}}}else{var
ga=new
Array(this.MV.childNodes.length);for(var
wa=0;wa<this.MV.childNodes.length;wa++){var
ja=this.MV.childNodes[wa];var
sa=new
Ma(ja);ga[wa]=sa.hasError()?ub.M+sa+ub.N:sa.toString();if(ja.nodeType==7||ja.nodeName==ub.L)ga[wa]+=ub.O;}}return ga.join(ub.g);};m.createDocumentElement=function(h,s){if(s==null)s=null;var
ha=this.MV.createElementNS(s,h);if(this.MV.documentElement!=null)this.MV.replaceChild(ha,this.MV.documentElement);else this.MV.appendChild(ha);this.CB(this.MV.documentElement);return new
jsx3.xml.Entity(ha);};m.createProcessingInstruction=function(d,h){var
sa=this.MV.createProcessingInstruction(d,h);this.MV.appendChild(sa);};m.setAsync=function(n){this._jsxhJ=n;return this;};m.getAsync=function(h){return Boolean(this._jsxhJ);};m.setSelectionLanguage=function(q){return this;};m.getSelectionLanguage=function(){return ub.P;};e.ao=function(d){var
Jb=[];for(var A in d)Jb[Jb.length]=ub.Q+d[A]+ub.R+A+ub.S;return Jb.join(ub.z);};m.setSelectionNamespaces=function(b){if(typeof b==ub.T)b=e.ao(b);this.MV._jsxIm=b;this.MV._jsxpd=null;return this;};m.getSelectionNamespaces=function(k){return this.MV._jsxIm?this.MV._jsxIm:ub.g;};m.createNamespaceAxis=function(){var
Qa=this.getRootNode();var
Ib=Qa.toString();var
Cb=ub.g;do{var
O=new
RegExp(ub.Q+ub.e+Cb+ub.U,ub.V);var
Jb=Ib.search(O);if(Jb>=0)Cb=Cb==ub.g?0:Cb+1;}while(Jb>=0);this.fv(Qa,ub.e+Cb);this.loadXML(this.getXML());return ub.e+Cb;};m.fv=function(l,f){var
sb=(l.cloneNode(false)).getXML();var
Kb;while(Kb=e.CE.exec(sb))if(RegExp.$1!=f&&RegExp.$1!=ub.L){var
F=l.createNode(2,f+ub.W+RegExp.$1,e.SEARCHABLE_NAMESPACE);F.setValue(RegExp.$2);l.setAttributeNode(F);}else if(RegExp.$1==ub.L)jsx3.log(sb);for(var
Ib=l.getChildIterator();Ib.hasNext();)this.fv(Ib.next(),f);};m.getDeclaredNamespaces=function(p){this._jsxNZ={};var
H=this.getRootNode();if(H)this.z8(H,{index:0},p);return this._jsxNZ;};m.z8=function(o,p,j){var
Y=o.getNamespaceURI();if(Y!=ub.g&&Y!=ub.X){var
X;if(!this._jsxNZ[Y]||j&&(X=o.getPrefix())!=ub.g&&typeof j[X]!=ub.Y)if(X){this._jsxNZ[Y]=X;}else{p.index+=1;this._jsxNZ[Y]=ub.Z+p.index;}}if(o.getNodeType()==1)for(var
w=o.selectNodeIterator(ub._);w.hasNext();){var
ia=w.next();if(ia.getNodeType()==1||ia.getNodeType()==2)this.z8(ia,p,j);}};m.getNativeDocument=function(){return this.MV;};e.Q2=function(n,b){if(e.dK==null)if(jsx3.util.Logger){e.dK=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.dK==null)return;}else return;e.dK.log(n,b);};e.getVersion=function(){return ub.aa;};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){var
...
ub={a:"end"};var
ka=jsx3.html;c.init=function(h){this.RW={elm:h,start:h.selectionStart,end:h.selectionEnd,scrollt:h.scrollTop,scrolll:h.scrollLeft};};c.getStartIndex=function(){return this.RW.start;};c.getEndIndex=function(){return this.RW.end;};c.setRange=function(n,b){this.RW.start=n;this.RW.end=b;this.RW.elm.setSelectionRange(n,b);};c.getOffsetLeft=function(){if(this.RW.pos==null)this.RW.pos=jsx3.html.getRelativePosition(null,this.RW.elm);return this.RW.pos.L;};c.getOffsetTop=function(){if(this.RW.pos==null)this.RW.pos=jsx3.html.getRelativePosition(null,this.RW.elm);return this.RW.pos.T;};c.getText=function(){return this.RW.elm.value.substring(this.RW.start,this.RW.end);};c.setText=function(k){this.RW.elm.value=this.RW.elm.value.substring(0,this.RW.start)+k+this.RW.elm.value.substring(this.RW.end);this.RW.elm.setSelectionRange(this.RW.start,this.RW.start+k.length);this.RW.elm.end=this.RW.elm.selectionEnd;};c.insertCaret=function(h){this.RW.elm.focus();if(h==ub.a){this.RW.elm.setSelectionRange(this.RW.elm.end,this.RW.elm.end);}else throw new
