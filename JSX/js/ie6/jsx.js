...
Ib=0;Ib<jsx3.C5.length;Ib++){Lb=jsx3.C5[Ib];if(jsx3.pP(Lb)){jsx3.wB=Lb;break;}}if(!jsx3.wB)throw new
...
Jb=[g,e,l];var
O=jsx3.e8;O[O.length]=Jb;if(e!=null)jsx3.pW[e]=Jb;if(!jsx3.yv)jsx3.yv=window.setTimeout(jsx3.DE,0);};jsx3.QUEUE_DONE=ub.z;jsx3.DE=function(){var
...
Wa=jsx3.util.Logger;if(Wa)Wa.GLOBAL.error(jsx3._msg(ub.C),jsx3.NativeError.wrap(Kb));}};jsx3.destroy=function(){if(jsx3.app&&jsx3.app.Server){var
ma=jsx3.app.Server.allServers();for(var
xb=0;xb<ma.length;xb++)try{ma[xb].destroy();}catch(Kb){}}if(jsx3.gui&&jsx3.gui.Event){var
Ba="BEFOREUNLOAD BLUR CHANGE CLICK DOUBLECLICK ERROR FOCUS KEYDOWN KEYPRESS KEYUP LOAD MOUSEDOWN MOUSEMOVE MOUSEOUT MOUSEOVER MOUSEUP MOUSEWHEEL UNLOAD RESIZE".split(ub.D);for(var
xb=0;xb<Ba.length;xb++)jsx3.gui.Event.unsubscribeAll(jsx3.gui.Event[Ba[xb]]);}jsx3.NativeError.stopErrorCapture();var
Pa=document.getElementsByTagName(ub.E);for(var
xb=0;xb<Pa.length;xb++){var
oa=Pa.item(xb);oa.parentNode.removeChild(oa);}if(window!=window.top||window.event.clientX<-1*window.screen.width&&window.event.clientY<-1*window.screen.height){}else{}jsx3.CLASS_LOADER.destroy();window.jsx3=null;};jsx3.getClass=function(i){try{var
Z=eval(i);return typeof Z==ub.F?Z:null;}catch(Kb){return null;}};jsx3.tl=function(o){try{var
I=eval(o+ub.G);return typeof I==ub.w&&typeof I.constructor==ub.F?I:null;}catch(Kb){return null;}};jsx3.getClassConstants=function(m){var
ua=jsx3.getClass(m);if(ua!=null){var
Mb=[];for(var ya in ua)if(ya.toUpperCase()==ya)Mb[Mb.length]=m+ub.g+ya;return Mb;}};jsx3.getInstanceMethods=function(k){var
L=jsx3.tl(k);var
pb=[];for(var Ta in L)if(typeof L[Ta]==ub.F){var
ua=L[Ta].toString();pb[pb.length]=ua.substring(9,ua.indexOf(ub.H)+1);}return pb;};jsx3.getClassMethods=function(f){var
Oa=jsx3.getClass(f);var
U=ub.r;for(var B in Oa)if(typeof Oa[B]==ub.F){var
y=Oa[B].toString();U=U+(B+y.substring(8,y.indexOf(ub.H)+1)+ub.I);}return U;};jsx3.doInherit=function(d,l,b){var
Fb=jsx3.getClass(d);var
F=jsx3.getClass(l);if(F==null){jsx3.util.Logger.doLog(ub.J,ub.K+l+ub.L+d+ub.M,1,false);return;}if(Fb.isInherited==null||b!=null&&b){if(!b){Fb.SUPER=l;Fb.SUPERS={};for(var U in F.SUPERS){Fb.SUPERS[U]=F.SUPERS[U];Fb.SUPERS[d]=1;}}Fb.className=d;if(Fb.INHERITANCE==null)Fb.INHERITANCE=[d];if(F.INHERITANCE)for(var
Y=F.INHERITANCE.length-1;Y>=0;Y--)Fb.INHERITANCE.splice(1,0,F.INHERITANCE[Y]);else Fb.INHERITANCE.splice(1,0,l);if(Fb.INTERFACES==null)Fb.INTERFACES={};if(F.INTERFACES){for(var U in F.INTERFACES)Fb.INTERFACES[U]=F.INTERFACES[U];}else Fb.INTERFACES[l]=ub.N;Fb.INTERFACES[d]=ub.N;if(!(b!=null&&b))Fb.isInherited=true;var
wa=jsx3.tl(l);var
J=jsx3.tl(d);for(var U in wa)if(typeof J[U]!=ub.F)J[U]=wa[U];}};jsx3.doImplement=function(m,b){jsx3.doInherit(m,b,true);};jsx3.doMixin=function(h,j){var
Ab=jsx3.tl(j);for(var Lb in Ab)if(typeof Ab[Lb]==ub.F)h[Lb]=Ab[Lb];};jsx3.doDefine=function(l,o){var
ga=jsx3.getClass(l);if(ga.isDefined==null){ga.isDefined=true;o();}};jsx3.out=function(p,d,i,j){if(jsx3.Class.forName(ub.O))jsx3.util.Logger.doLog(p,d,i,j);};window.doInherit=jsx3.doInherit;window.doImplement=jsx3.doImplement;window.doMixin=jsx3.doMixin;window.doDefine=jsx3.doDefine;jsx3.log=function(q){if(jsx3.Class.forName(ub.O)&&jsx3.util.Logger.GLOBAL){if(jsx3.GP){for(var
cb=0;cb<jsx3.GP.length;cb++)jsx3.util.Logger.GLOBAL.info(jsx3.GP[cb]);delete jsx3[ub.P];}jsx3.util.Logger.GLOBAL.info(q);}else{var
F=jsx3.GP;if(!F)jsx3.GP=F=[];F[F.length]=q;}};});jsx3.Package.definePackage("jsx3.app",function(){});jsx3.Boolean={};jsx3.Boolean.TRUE=1;jsx3.Boolean.FALSE=0;jsx3.Boolean.valueOf=function(m){return m?1:0;};jsx3.Package.definePackage("jsx3.gui",function(m){var
ub={a:"className"};m.no=function(b,q){var
K=[];for(var
Ya=0;Ya<arguments.length-1;Ya=Ya+2){b=arguments[Ya];if(b._jsxRr)continue;b._jsxRr=true;q=arguments[Ya+1];var
Ua={};for(var ra in q)Ua[ra]=ra==ub.a?b.className:b.style[ra];K.push(b,Ua,q);}m.NF(K,0,6);};m.NF=function(r,q,d){if(q==d){for(var
y=0;y<r.length-2;y=y+3){var
ua=r[y];ua._jsxRr=null;}return;}for(var
y=0;y<r.length-2;y=y+3){var
ua=r[y];var
aa=q%2==0?r[y+2]:r[y+1];for(var P in aa)if(P==ub.a)ua.className=aa[P];else ua.style[P]=aa[P];}window.setTimeout(function(){m.NF(r,q+1,d);},75);};m.isMouseEventModKey=function(d){if(jsx3.app.Browser.macosx)return d.metaKey();else return d.ctrlKey();};});jsx3.Package.definePackage("jsx3.lang",function(l){});jsx3.Package.definePackage("jsx3.net",function(e){});jsx3.Class.defineInterface("jsx3.net.URIResolver",null,function(k,h){var
ub={a:"jsxabspath",b:"jsxhomepath",c:"jsxscriptapppath",d:"JSXAPPS",e:"/",f:"..",g:"jsx",h:"JSX",i:"jsxuser",j:"GI_Builder/",k:"function",l:"jsxurirslv",m:"3.6",n:"strURI",o:"bRel"};k.wK={};k.register=function(j,e){k.wK[j]=e;};k.eX=function(){if(this.V0==null)this.V0=new
jsx3.net.URI(jsx3.getEnv(ub.a));return this.V0;};k.PN=function(){var
eb=jsx3.getEnv(ub.b);if(eb==null)return new
jsx3.net.URI(jsx3.getEnv(ub.c));if(this.my==null)this.my=new
jsx3.net.URI(eb);return this.my;};k.DEFAULT=k.jsxclass.newInnerClass();k.DEFAULT.resolveURI=function(p){var
E=jsx3.net.URI.valueOf(p);var
vb=E.getScheme();var
Mb=E.getPath();var
Kb=k.getResolver(E);var
eb=E;if(Kb&&Kb!=k.DEFAULT){if(E.isAbsolute())E=jsx3.net.URI.fromParts(null,null,null,null,Mb.substring(1),E.getQuery(),E.getFragment());eb=Kb.resolveURI(E);}else if(Kb){eb=(k.eX()).resolve(E);}else if((E.toString()).indexOf(ub.d+ub.e)==0){eb=k.USER.resolveURI(E);}else if(!vb&&Mb.indexOf(ub.f)>=0){var
zb=jsx3.app.Browser.getLocation();eb=zb.relativize(zb.resolve(E));}return eb;};k.DEFAULT.getUriPrefix=function(){return (k.eX()).toString();};k.DEFAULT.relativizeURI=function(o,c){return jsx3.net.URI.valueOf(o);};k.JSX=k.jsxclass.newInnerClass();k.register(ub.g,k.JSX);k.JSX.getURI=function(){if(this._uri==null)this._uri=(k.eX()).resolve(ub.h+ub.e);return this._uri;};k.JSX.resolveURI=function(m){var
Ua=jsx3.net.URI.valueOf(m);if(!k.isAbsoluteURI(Ua))Ua=(this.getURI()).resolve(Ua);return k.DEFAULT.resolveURI(Ua);};k.JSX.getUriPrefix=function(){return k.eX()+ub.h+ub.e;};k.JSX.relativizeURI=function(o,c){var
ya=(this.getURI()).relativize(o);if(ya.isAbsolute()||c)return ya;else return jsx3.net.URI.fromParts(ub.g,null,null,null,ub.e+ya.getPath(),ya.getQuery(),ya.getFragment());};k.USER=k.jsxclass.newInnerClass();k.register(ub.i,k.USER);k.USER.resolveURI=function(l){var
ya=jsx3.net.URI.valueOf(l);if((ya.getPath()).indexOf(ub.d+ub.e)==0||!k.isAbsoluteURI(ya))return (k.PN()).resolve(ya);return k.DEFAULT.resolveURI(ya);};k.USER.getUriPrefix=function(){return (k.PN()).toString();};k.USER.relativizeURI=function(g,n){var
pa=jsx3.app.Browser.getLocation();var
Ja=(pa.resolve(jsx3.getEnv(ub.b))).relativize(pa.resolve(g));if(Ja.isAbsolute()||n)return Ja;else return jsx3.net.URI.fromParts(ub.i,null,null,null,ub.e+Ja.getPath(),Ja.getQuery(),Ja.getFragment());};k.isAbsoluteURI=function(f){var
D=jsx3.net.URI.valueOf(f);if(D.getScheme()!=null)return true;var
K=D.getPath();return K.indexOf(ub.e)==0||K.indexOf(ub.h+ub.e)==0||K.indexOf(ub.d+ub.e)==0||K.indexOf(ub.j)==0;};k.getResolver=function(i){var
Wa=jsx3.net.URI.valueOf(i);var
z=Wa.getScheme();var
K=null;if(z){K=k.wK[z];if(typeof K==ub.k)K=K(Wa);}else{var
Cb=Wa.getPath();if(Cb.indexOf(ub.h+ub.e)==0||Cb.indexOf(ub.j)==0)K=k.DEFAULT;else if(jsx3.getEnv(ub.l)==ub.m&&Cb.indexOf(ub.d+ub.e)==0)K=k.USER;}return K;};h.resolveURI=jsx3.Method.newAbstract(ub.n);h.getUriPrefix=jsx3.Method.newAbstract();h.relativizeURI=jsx3.Method.newAbstract(ub.n,ub.o);});jsx3.Package.definePackage("jsx3.xml",function(l){});jsx3.Package.definePackage("jsx3.util",function(c){var
...
Ka=k.tZ();if(Ka!=null&&Ka.isLoggable(5))Ka.debug(ub.M+c+ub.A+((g.toString()).substring(0,50)).replace(ub.B,ub.C));k.n9.unsubscribe(c,g);if(k.n9.getSubscriberCount(c)==0)k.Fw(c);};k.unsubscribeAll=function(l){var
w=k.tZ();if(w!=null&&w.isLoggable(5))w.debug(ub.N+l+ub.F);k.n9.unsubscribeAll(l);k.Fw(l);};k.publish=function(i){var
X={subject:i.getType(),target:k,event:i};k.PA(X);};k.PA=function(f){var
cb=ub.y+f.subject.toLowerCase();var
sb=k.tZ();if(sb!=null&&sb.isLoggable(6))sb.trace(ub.O+cb+ub.F);var
Ba=k.NC[0];if(Ba[cb]!=null)Ba[cb]();k.n9.publish(f);};k.Ft=function(i){var
Xa=new
k(i!=null?i:window.event);var
u=k.tZ();if(u!=null&&u.isLoggable(6))u.trace(ub.P+Xa.getType()+ub.F);if(Xa.getType()==ub.s){var
Ga=document.body.offsetWidth,X=document.body.offsetHeight;if(Ga===k.yP&&X===k._E)return;k.yP=Ga;k._E=X;}var
P={subject:Xa.getType(),target:k,event:Xa};k.PA(P);if(P.returnValue)return P.returnValue;};k.Fw=function(e){var
w=ub.y+e;var
gb=k.tZ();var
ra=k.cp(e)?[window]:k.cx;for(var
H=0;H<ra.length;H++)try{var
E=ra[H];var
T=k.gG(E,e);if(T.attachEvent&&k.HS(e)){var
N=k.LS[H];if(N[e]){if(gb!=null&&gb.isLoggable(5))gb.debug(ub.Q+e+ub.R+T);T.detachEvent(w,k.Ft);N[e]=false;}}else if(T.removeEventListener&&k.l1(e)){var
N=k.LS[H];if(N[e]){if(gb!=null&&gb.isLoggable(5))gb.debug(ub.S+e+ub.R+T+ub.F);T.removeEventListener(e,k.Ft,false);N[e]=false;}}else{var
db=k.NC[H];if(gb!=null&&gb.isLoggable(5))gb.debug(ub.T+w+ub.I+T+ub.F);if(db[w]!=null){T[w]=db[w];delete db[w];}else T[w]=null;}}catch(Kb){if(gb!=null&&gb.isLoggable(5))gb.debug(ub.J+e,jsx3.NativeError.wrap(Kb));k._deregisterWindow(E);H--;}};k.gG=function(e,d){return d==ub.a||d==ub.r||d==ub.s?e:e.document;};k.HS=function(j){return j!=ub.a;};k.l1=function(m){return m!=ub.a;};k.cp=function(m){return m==ub.a||m==ub.r;};a.init=function(c,q){this.yq=c;if(q)this._clone=jsx3.clone(c);};a.yh=function(){if(this._clone==null)this._clone=jsx3.clone(this.yq);this._clone._jsxky=true;};k.wrap=function(f,e){return f instanceof k?f:new
k(f,e);};k.getCurrent=function(h){return window.event?new
k(window.event,h):null;};a.Vu=function(){try{if(this.yq==null)return this._clone;else if(typeof this.yq.type==ub.U)return this.yq;}catch(Kb){}this.yq=null;return this._clone;};a.event=function(){return this.Vu();};a.getType=function(){return (this.Vu()).type;};a.srcElement=function(){var
Ua=this.Vu();return Ua.target||Ua.srcElement;};a.toElement=function(){var
fa=this.Vu();return fa.toElement;};a.fromElement=function(){var
E=this.Vu();return E.fromElement;};a.isMouseEvent=function(){var
Ib=this.getType()||ub.V;return Ib.indexOf(ub.W)==0||Ib==ub.d||Ib==ub.e;};a.isKeyEvent=function(){return (this.getType()||ub.V).indexOf(ub.X)==0;};a.setCapture=function(m){m.setCapture();};a.releaseCapture=function(j){j.releaseCapture();};a.keyCode=function(){var
La=this.Vu();return La.keyCode;};a.clientX=function(){var
eb=this.Vu();return eb?eb.clientX:Number.NaN;};a.clientY=function(){var
wb=this.Vu();return wb?wb.clientY:Number.NaN;};a.getOffsetX=function(){return (this.Vu()).offsetX-(this.Vu()).srcElement.scrollLeft;};a.getOffsetY=function(){return (this.Vu()).offsetY-(this.Vu()).srcElement.scrollTop;};a.getScreenX=function(){return (this.Vu()).screenX;};a.getScreenY=function(){return (this.Vu()).screenY;};a.getTrueX=function(){return (this.Vu()).clientX;};a.getTrueY=function(){return (this.Vu()).clientY;};a.getWheelDelta=function(){var
Za=(this.Vu()).wheelDelta;var
xa=Za>0?Math.ceil(Za/120):Math.floor(Za/120);return xa;};a.shiftKey=function(){var
bb=this.Vu();return bb.shiftKey;};a.ctrlKey=function(){var
_a=this.Vu();return _a.ctrlKey;};a.altKey=function(){var
w=this.Vu();return w.altKey;};a.metaKey=function(){return false;};a.enterKey=function(){return (this.Vu()).keyCode==13;};a.spaceKey=function(){return (this.Vu()).keyCode==32;};a.tabKey=function(){return (this.Vu()).keyCode==9;};a.rightArrow=function(){return (this.Vu()).keyCode==39;};a.leftArrow=function(){return (this.Vu()).keyCode==37;};a.upArrow=function(){return (this.Vu()).keyCode==38;};a.downArrow=function(){return (this.Vu()).keyCode==40;};a.deleteKey=function(){return (this.Vu()).keyCode==46;};a.backspaceKey=function(){return (this.Vu()).keyCode==8;};a.insertKey=function(){return (this.Vu()).keyCode==45;};a.homeKey=function(){return (this.Vu()).keyCode==36;};a.endKey=function(){return (this.Vu()).keyCode==35;};a.pageUpKey=function(){return (this.Vu()).keyCode==33;};a.pageDownKey=function(){return (this.Vu()).keyCode==34;};a.escapeKey=function(){return (this.Vu()).keyCode==27;};a.exists=function(){return this.Vu()!=null;};a.cancelBubble=function(){var
fa=this.Vu();fa.cancelBubble=true;};a.cancelReturn=function(){(this.Vu()).returnValue=false;};a.preventDefault=function(){var
Mb=this.Vu();try{Mb.keyCode=0;Mb.returnValue=false;}catch(Mb){}};a.cancelKey=function(){var
Aa=this.Vu();try{Aa.keyCode=0;Aa.returnValue=false;}catch(Aa){var
...
ba=this.Vu();if(jsx3.app.Browser.macosx&&ba.ctrlKey)return false;var
...
Fb=this.Vu();return Fb.button;};a.setReturn=function(j){(this.Vu()).returnValue=j;};a.setKeyCode=function(i){(this.Vu()).keyCode=i;};a.isModifierKey=function(){var
J=this.Vu();return J.keyCode==16||J.keyCode==17||J.keyCode==18||J.keyCode==224;};a.hasModifier=function(l){return !l&&this.shiftKey()||this.ctrlKey()||this.altKey()||this.metaKey();};a.isArrowKey=function(){var
...
T=this.Vu();if(T==null)return ub.aa;var
hb=[];for(var ua in T)if(typeof T[ua]!=ub.L)hb[hb.length]=ua;hb.sort();var
Pa=[ub.ba];for(var
ib=0;ib<hb.length;ib++)Pa[Pa.length]=hb[ib]+ub.ca+T[hb[ib]]+ub.C;return Pa.join(ub.V);};});jsx3.gui.Event.subscribe("unload",jsx3.destroy);jsx3.Class.defineClass("jsx3.EVT",null,[jsx3.util.EventDispatcher],function(e,h){var
...
S=this.bW.attributes;var
ca=new
Array(S.length);for(var
rb=0;rb<ca.length;rb++)ca[rb]=S[rb].nodeName;return ca;};a.getRootNode=function(){return this.bW?new
m(this.Kt(1)):null;};a.getParent=function(){return this.bW!=this.Kt(1)?new
m(this.bW.parentNode):null;};a.getChildIterator=function(k){return new
m.ChildIterator(this.bW?this.bW.childNodes:[],k);};a.getChildNodes=function(j){if(!this.bW)return new
m.List([]);var
Ra=this.bW.childNodes;var
U=[];for(var
va=0;va<Ra.length;va++){var
ba=Ra[va];if(ba.nodeType==1||j&&(ba.nodeType==3||ba.nodeType==4))U[U.length]=ba;}return new
m.List(U);};a.removeChild=function(c){var
ba=c.getParent();return ba!=null&&ba.equals(this)?new
m(this.bW.removeChild(c.bW)):null;};a.removeChildren=function(){var
xb=this.bW.childNodes;for(var
E=xb.length-1;E>=0;E--)this.bW.removeChild(xb[E]);};a.removeAttribute=function(h){if(this.fA==1)this.bW.removeAttribute(h);};a.removeAttributeNode=function(g){this.bW.removeAttributeNode(g.bW);return this;};a.equals=function(j){return j!=null&&j.bW==this.bW;};a.getNodeType=function(){return this.fA;};a.getNodeName=function(){return this.bW.nodeName;};a.getNamespaceURI=function(){var
ka=this.bW.namespaceURI;if(ka==null)ka=ub.b;return ka;};a.selectSingleNode=function(c,i){if(!this.bW)return null;return this.rt(c,i,0);};a.selectNodes=function(s,l){if(!this.bW)return new
m.List([]);return this.rt(s,l,1);};a.selectNodeIterator=function(q,n){if(!this.bW)return new
m.SelectIterator();return this.rt(q,n,2);};a.getBaseName=function(){return this.bW.baseName;};a.getPrefix=function(){return this.bW.prefix;};a.getXML=function(){return this.bW.xml;};a.toString=function(){var
Ba=ub.e+(this.getClass()).getName();if(this.bW!=null&&!this.hasError()){return this.bW.xml?this.bW.xml:this.bW.outerHTML?this.bW.outerHTML:jsx3._msg(ub.f,Ba);}else return this.hasError()?jsx3._msg(ub.g,Ba,this.getError()):jsx3._msg(ub.h,Ba);};a.getValue=function(){return this.fA==1?this.bW.text:this.bW.nodeValue;};a.setValue=function(s){if(s==null)s=ub.b;else s=String(s);if(this.fA==1){this.bW.text=s;}else this.bW.nodeValue=s;return this;};a.rt=function(h,d,c){if(typeof d==ub.i)d=jsx3.xml.Document.ao(d);var
Ib,Jb=null;if(d!=null){Jb=this.bW.ownerDocument;Ib=Jb.getProperty(ub.j);Jb.setProperty(ub.j,d);}var
pa=null,Hb;if(c){try{Hb=this.bW.selectNodes(h);}catch(Kb){Hb=[];}pa=c==2?new
m.SelectIterator(Hb):new
m.List(Hb);}else{try{var
E=this.bW.selectSingleNode(h);}catch(Kb){}pa=E?new
m(E):null;}if(Jb)Jb.setProperty(ub.j,Ib);return pa;};a.Kt=function(d){if(d==null){return this.bW.ownerDocument;}else if(d==1){var
Qa=this.bW.ownerDocument;return Qa!=null?Qa.documentElement:null;}else if(d==2)return this.bW.documentElement;};a.getNative=function(){return this.bW;};a.getFirstChild=function(){if(this.fA==1){var
kb=this.bW.firstChild;while(kb!=null&&kb.nodeType!=1)kb=kb.nextSibling;if(kb!=null)return new
m(kb);}return null;};a.getLastChild=function(){if(this.fA==1){var
sa=this.bW.lastChild;while(sa!=null&&sa.nodeType!=1)sa=sa.previousSibling;if(sa!=null)return new
m(sa);}return null;};a.getPreviousSibling=function(){if(this.fA==1){var
bb=this.bW.previousSibling;while(bb!=null&&bb.nodeType!=1)bb=bb.previousSibling;if(bb!=null)return new
m(bb);}return null;};a.getNextSibling=function(){if(this.fA==1){var
Cb=this.bW.nextSibling;while(Cb!=null&&Cb.nodeType!=1)Cb=Cb.nextSibling;if(Cb!=null)return new
m(Cb);}return null;};a.transformNode=function(n,f,d){jsx3.require(ub.k);var
cb=new
jsx3.xml.Template(n);if(f)cb.setParams(f);return cb[d?ub.l:ub.m](this);};m.OR=function(){};m.OR.prototype.toString=function(){return ub.n+this.code+ub.o+(typeof this.description!=ub.p?ub.q+this.description:ub.b);};a.Dk=function(n,q){if(this.dN==null)this.dN=new
...
jsx3.xml.Document(this.Kt()):null;};m.getVersion=function(){return ub.r;};});jsx3.Entity=jsx3.xml.Entity;jsx3.Class.defineClass("jsx3.xml.Entity.List",jsx3.util.List,null,function(o,m){var
ub={a:"Not implemented",b:"[",c:"]"};var
la=jsx3.Exception;m.init=function(k){this.jsxsuper(null,true);this.aV=k;};m.get=function(s){var
va=this.aV[s];return va!=null?new
jsx3.xml.Entity(va):va;};var
Xa=ub.a;m.add=function(){throw new
la(Xa);};m.addAll=function(){throw new
la(Xa);};m.set=function(){throw new
la(Xa);};m.remove=function(){throw new
la(Xa);};m.removeAt=function(){throw new
la(Xa);};m.sort=function(){throw new
la(Xa);};m.slice=function(h,e){return new
o(arguments.length>1?this.aV.slice(h,e):this.aV.slice(h));};m.toString=function(){return ub.b+this.toArray()+ub.c;};m.clone=function(){return new
o(this.aV.concat());};m.toArray=function(){var
ca=this.size();var
qb=new
Array(ca);for(var
Ia=0;Ia<ca;Ia++)qb[Ia]=this.get(Ia);return qb;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(c,g){g.init=function(n,f){this.QN=n;this.ty=0;this.Ny=f;this.i6();this.bW=null;};g.next=function(){if(!this._next)return null;if(this.bW){this.bW.init(this._next);}else this.bW=new
jsx3.xml.Entity(this._next);this.i6();return this.bW;};g.hasNext=function(){return this._next!=null;};g.i6=function(){this._next=null;var
Oa=this.QN;var
Fa=Oa.length;while(this._next==null&&this.ty<Fa){var
H=Oa[this.ty];if(H.nodeType==1||this.Ny&&(H.nodeType==3||H.nodeType==4))this._next=H;this.ty++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(d,h){h.init=function(l){this.OC=l;this.x2=0;this.bW=null;};h.next=function(){var
E=this.OC[this.x2++];if(!E)return null;if(this.bW){this.bW.init(E);}else this.bW=new
jsx3.xml.Entity(E);return this.bW;};h.hasNext=function(){return this.OC&&this.x2<this.OC.length;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(g,f){var
ub={a:"response",b:"timeout",c:"req_inst",d:"_timeoutto",e:"getAllResponseHeaders",f:"getResponseHeader",g:"statusText",h:"status",i:"req.bad_xml",j:"req.open",k:"req.err_open",l:"The HTTP ActiveX object does not appear to support setting timeouts.",m:"req.err_state",n:"hS",o:"req.err_send",p:" ",q:"3.00.00"};g.STATUS_OK=200;g.STATUS_ERROR=400;g.EVENT_ON_RESPONSE=ub.a;g.EVENT_ON_TIMEOUT=ub.b;g.uV={};f.init=function(d){if(d!=null)g.uV[d]=this;try{this.QF=jsx3.getHttpInstance();}catch(Kb){throw new
...
M=C.getScheme();var
Q=g._HANDLERS[M]||g.jsxclass;return (Q.newInstance()).open(m,C,s,h,c);};g._HANDLERS={};g.addSchemeHandler=function(n,s){g._HANDLERS[n]=s;};g.getSchemeHandler=function(b){return g._HANDLERS[b];};f.open=function(m,k,s,a,o){this.hS=0;this.OJ=Boolean(s);this.yT=m;this.eE=jsx3.net.URIResolver.DEFAULT.resolveURI(k);try{g.Q2(6,jsx3._msg(ub.j,this.eE));this.QF.open(m,this.eE.toString(),this.OJ,a,o);}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.k,k,jsx3.NativeError.wrap(Kb)));}return this;};g.cancelRequest=function(c){var
Da=g.uV[c];if(Da)Da.abort();};g.getRequest=function(h){return g.uV[h];};f.getURL=function(){return this.eE&&this.eE.toString();};f.setTimeouts=function(a,o,j,r){try{this.QF.setTimeouts(a,o,j,r);}catch(Kb){g.Q2(3,ub.l);}return this;};f.send=function(d,m){if(this.hS==400)throw new
jsx3.Exception(jsx3._msg(ub.m));var
ha=false;try{if(!this.OJ)g.INSYNC=true;this.QF.send(d);if(this.OJ)this.hS=0;else delete this[ub.n];}catch(Kb){this.hS=400;g.Q2(2,jsx3._msg(ub.o,this.eE,jsx3.NativeError.wrap(Kb)));ha=this;}finally{g.INSYNC=false;}if(this.OJ)if(ha||this.QF.readyState==4){jsx3.sleep(function(){this.publish({subject:ub.a});},null,this);}else{var
jb=this;this.QF.onreadystatechange=function(){if(jb.QF.readyState==4)if(g.INSYNC){jsx3.sleep(function(){jb.nG();});}else jb.nG();};if(!isNaN(m)&&m>0)this._timeoutto=window.setTimeout(function(){jb.LZ();},m);}return this;};f.LZ=function(){delete this[ub.d];this.abort();this.hS=408;this.publish({subject:ub.b});};f.nG=function(){delete this[ub.n];if(this._timeoutto){window.clearTimeout(this._timeoutto);delete this[ub.d];}this.QF.onreadystatechange=new
Function();this.publish({subject:ub.a});};f.toString=function(){return this.jsxsuper()+ub.p+this.yT+ub.p+this.getStatus()+ub.p+this.eE;};g.Q2=function(k,j){if(g.dK==null)if(jsx3.util.Logger){g.dK=jsx3.util.Logger.getLogger(g.jsxclass.getName());if(g.dK==null)return;}else return;g.dK.log(k,j);};g.getVersion=function(){return ub.q;};});jsx3.HttpRequest=jsx3.net.Request;jsx3.Class.defineClass("jsx3.xml.Document",jsx3.xml.Entity,[jsx3.util.EventDispatcher],function(e,m){var
ub={A:"xml.unknown",B:"version",C:"encoding",D:"standalone",E:"yes",F:"xml",G:"\\b",H:'="(.*?)"',I:"i",J:"1.0",K:"<?xml",L:' version="',M:' encoding="',N:' standalone="',O:"no",P:"?>\n",Q:"<!-- ",R:" -->",S:"\n",T:"='",U:"'",V:"object",W:"SelectionNamespaces",X:"xml.selns",Y:"([^=]*)=['\"]([^\"^']*)['\"]",Z:"g",_:":",a:"response",aa:"http://www.w3.org/XML/1998/namespace",b:"error",ba:"undefined",c:"timeout",ca:"jsx",d:"http://xsd.tns.tibco.com/gi/cxf/2006",da:"attribute::* | child::*",e:"jsx_xmlns",ea:"3.0.0",f:/xmlns:([^=]*)=['\"]([^\"^']*)['\"]/g,g:"SelectionLanguage",h:"XPath",i:"ForcedResync",j:"xml.parser",k:"MV",l:"GET",m:"*",n:"CY",o:"lw",XV:"",q:"content-type",r:/xml|xsl/i,s:"xml.doc_status",t:"xml.timeout",u:"xmlns:",v:'="',w:'"',x:" ",y:"0",z:"xml.err_fmt"};var
Ma=jsx3.xml.Entity;e.ON_RESPONSE=ub.a;e.ON_ERROR=ub.b;e.ON_TIMEOUT=ub.c;e.SEARCHABLE_NAMESPACE=ub.d;e.SEARCHABLE_PREFIX=ub.e;e.CE=ub.f;try{var
...
ib=p.target;var
Oa=p.subject;delete this[ub.o];ib.unsubscribe(ub.m,this);if(Oa==ub.a){this.po(ib);}else if(Oa==ub.c){this.Dk(111,jsx3._msg(ub.t));this.publish({subject:ub.c});}else e.Q2();};m.CB=function(f){Ma.prototype.init.call(this,f);var
Ja=[];var
nb=this.getAttributeNames();for(var
Eb=0;Eb<nb.length;Eb++){var
W=nb[Eb];if(W.indexOf(ub.u)==0)Ja[Ja.length]=W+ub.v+this.getAttribute(W)+ub.w;}this.setSelectionNamespaces(Ja.join(ub.x));};m.loadXML=function(o){this.eE=null;this.Dk(0);try{this.MV.loadXML(o);if(!this.X8(this.MV))this.CB(this.MV.documentElement);}catch(Kb){this.X8(this.MV,jsx3.NativeError.wrap(Kb));}return this;};m.getSourceURL=function(){return this.eE;};m.X8=function(b,q){if(b!=null){var
K=b.parseError;if(K!=null&&K.errorCode!=ub.y){var
va=jsx3._msg(ub.z,K.errorCode,K.line,K.linepos,jsx3.util.strTrim(String(K.reason)),jsx3.util.strTruncate(K.srcText),K.url);this.Dk(K.errorCode,va);return true;}}if(q!=null){this.Dk(110,jsx3._msg(ub.A,jsx3.NativeError.wrap(q)));return true;}return false;};m.getValidateOnParse=function(){return this.MV.validateOnParse;};m.setValidateOnParse=function(a){this.MV.validateOnParse=a;};m.getResolveExternals=function(){return this.MV.resolveExternals;};m.setResolveExternals=function(d){this.MV.resolveExternals=d;};m.toString=function(){if(this.MV!=null&&!this.hasError()){var
db=this.MV.xml;if(db.charCodeAt(db.length-1)==10&&db.charCodeAt(db.length-2)==13)db=db.substring(0,db.length-2);return db;}else return this.jsxsuper();};m.getXmlVersion=function(){return this.sL(ub.B);};m.getXmlEncoding=function(){return this.sL(ub.C);};m.getXmlStandalone=function(){return this.sL(ub.D)==ub.E;};m.sL=function(b){var
yb=this.MV.childNodes[0];if(yb.nodeType==7&&yb.nodeName==ub.F){var
Na=new
RegExp(ub.G+b+ub.H,ub.I);if(yb.nodeValue.match(Na))return RegExp.$1;}return null;};m.cloneDocument=function(){return new
e(this.MV.cloneNode(true));};m.serialize=function(o,b,s){if(o===true)o=this.getXmlVersion()||ub.J;if(b===true)b=this.getXmlEncoding();var
J=o||b||s;if(J){var
O=ub.K;if(o)O=O+(ub.L+o+ub.w);if(b)O=O+(ub.M+b+ub.w);if(s!=null)O=O+(ub.N+(s?ub.E:ub.O)+ub.w);O=O+ub.P;var
ab=new
Array(this.MV.childNodes.length+1);ab[0]=O;for(var
Db=0;Db<this.MV.childNodes.length;Db++){var
t=this.MV.childNodes[Db];if(t.nodeType!=7||t.nodeName!=ub.F){var
L=new
Ma(t);ab[Db+1]=L.hasError()?ub.Q+L+ub.R:L.toString();}}}else{var
ab=new
Array(this.MV.childNodes.length);for(var
Db=0;Db<this.MV.childNodes.length;Db++){var
t=this.MV.childNodes[Db];var
L=new
Ma(t);ab[Db]=L.hasError()?ub.Q+L+ub.R:L.toString();if(t.nodeType==7||t.nodeName==ub.F)ab[Db]+=ub.S;}}return ab.join(ub.XV);};m.createDocumentElement=function(l,o){if(o){var
Y=this.MV.createNode(1,l,o);}else var
Y=this.MV.createElement(l);if(this.MV.documentElement!=null)this.MV.replaceChild(Y,this.MV.documentElement);else this.MV.appendChild(Y);this.CB(this.MV.documentElement);return new
jsx3.xml.Entity(Y);};m.createProcessingInstruction=function(p,o){var
Ra=this.MV.createProcessingInstruction(p,o);this.MV.appendChild(Ra);};m.setAsync=function(h){this._jsxhJ=h;return this;};m.getAsync=function(g){return Boolean(this._jsxhJ);};m.setSelectionLanguage=function(g){return this;};m.getSelectionLanguage=function(){return this.MV.getProperty(ub.g);};e.ao=function(k){var
_a=[];for(var ka in k)_a[_a.length]=ub.u+k[ka]+ub.T+ka+ub.U;return _a.join(ub.x);};m.setSelectionNamespaces=function(n){if(typeof n==ub.V)n=e.ao(n);try{this.MV.setProperty(ub.W,n);}catch(Kb){this.Dk(113,jsx3._msg(ub.X,n,jsx3.NativeError.wrap(Kb)));}return this;};m.getSelectionNamespaces=function(q){return this.MV.getProperty(ub.W);};m.createNamespaceAxis=function(){var
fb=this.getRootNode();var
Db=fb.toString();var
da=ub.XV;do{var
S=new
RegExp(ub.u+ub.e+da+ub.Y,ub.Z);var
ha=Db.search(S);if(ha>=0)da=da==ub.XV?0:da+1;}while(ha>=0);this.fv(fb,ub.e+da);return ub.e+da;};m.fv=function(l,f){var
Ha=(l.cloneNode(false)).getXML();var
rb;while(rb=e.CE.exec(Ha))if(RegExp.$1!=f&&RegExp.$1!=ub.F){var
ma=l.createNode(2,f+ub._+RegExp.$1,e.SEARCHABLE_NAMESPACE);ma.setValue(RegExp.$2);l.setAttributeNode(ma);}else if(RegExp.$1==ub.F)jsx3.log(Ha);for(var
Lb=l.getChildIterator();Lb.hasNext();)this.fv(Lb.next(),f);};m.getDeclaredNamespaces=function(j){this._jsxNZ={};var
ja=this.getRootNode();if(ja)this.z8(ja,{index:0},j);return this._jsxNZ;};m.z8=function(d,h,p){var
Ha=d.getNamespaceURI();if(Ha!=ub.XV&&Ha!=ub.aa){var
Hb;if(!this._jsxNZ[Ha]||p&&(Hb=d.getPrefix())!=ub.XV&&typeof p[Hb]!=ub.ba)if(Hb){this._jsxNZ[Ha]=Hb;}else{h.index+=1;this._jsxNZ[Ha]=ub.ca+h.index;}}if(d.getNodeType()==1)for(var
u=d.selectNodeIterator(ub.da);u.hasNext();){var
E=u.next();if(E.getNodeType()==1||E.getNodeType()==2)this.z8(E,h,p);}};m.getNativeDocument=function(){return this.MV;};e.Q2=function(d,l){if(e.dK==null)if(jsx3.util.Logger){e.dK=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.dK==null)return;}else return;e.dK.log(d,l);};e.getVersion=function(){return ub.ea;};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){var
ub={a:"temp.init_err",b:"stylesheet",c:"/xsl:stylesheet/xsl:param",d:"name",e:"temp.nat_err",f:"temp.root_elm",g:"",h:"temp.temp_err",i:"temp.doc_err",j:"temp.err"};p.DISABLE_OUTPUT_ESCAPING=1;p.s6={};p.s6[1]=true;p.supports=function(d){return p.s6[d]||Boolean(0);};s.init=function(m){if(m.hasError())throw new
...
Ma=jsx3.getXslInstance();Ma.stylesheet=m.getNativeDocument();this.hM=Ma.createProcessor();}catch(Kb){this.Dk(200,jsx3._msg(ub.e,jsx3.NativeError.wrap(Kb)));}}else this.Dk(201,jsx3._msg(ub.f));};s.setParam=function(f,j){if(!this.X3)this.X3=new
jsx3.util.List();if(this.X3.indexOf(f)<0)this.X3.add(f);this.hM.addParameter(f,j!=null?j.toString():ub.g);};s.c1=function(j,b){this.hM.input=j instanceof jsx3.xml.Document?j.getNativeDocument():j.getNative();this.hM.transform();var
A=b?(new
jsx3.xml.Document()).loadXML(this.hM.output):this.hM.output;this.hM.input=null;return A;};s.reset=function(){for(var bb in this.RS)this.hM.addParameter(bb,this.RS[bb]);};s.setParams=function(d){for(var La in d)this.setParam(La,d[La]);};s.transform=function(a,k){if(this.hasError())throw new
jsx3.Exception(jsx3._msg(ub.h,this.getError()));if(a.hasError())throw new
jsx3.Exception(jsx3._msg(ub.i,a.getError()));try{return this.c1(a,k);}catch(Kb){this.Dk(204,jsx3._msg(ub.j,jsx3.NativeError.wrap(Kb)));return null;}};s.transformToObject=function(d){return this.transform(d,true);};s.toString=function(){return this._src;};});jsx3.xml.Entity.jsxclass.mixin(jsx3.xml.Template.prototype,true,["getError","hasError","Dk"]);jsx3.Class.defineClass("jsx3.xml.XslDocument",jsx3.xml.Document,null,function(n,h){var
ub={a:"temp.parse",b:"_M"};h.setParam=function(c,g){(this.Z6()).setParam(c,g);};h.setParams=function(r){(this.Z6()).setParams(r);};h.reset=function(){if(this._M)this._M.reset();};h.transform=function(o){return (this.Z6()).transform(o);};h.transformToObject=function(m){return (this.Z6()).transformToObject(m);};h.Z6=function(){if(this._M==null){this._M=new
jsx3.xml.Template(this);if(this._M.hasError())throw new
jsx3.Exception(jsx3._msg(ub.a,this.getSourceURL(),this._M.getError()));}return this._M;};h.load=function(p){delete this[ub.b];return this.jsxsuper(p);};h.loadXML=function(f){delete this[ub.b];return this.jsxsuper(f);};h.hasError=function(){return this.jsxsuper()||this._M!=null&&this._M.hasError();};h.getError=function(){var
fa=null;if(this._M)fa=this._M.getError();if(!fa)fa=this.jsxsuper();return fa;};n.wrap=function(m){return new
n(m.getNativeDocument());};h.cloneDocument=function(){return n.wrap(this.jsxsuper());};h.isMutable=function(){return this._M==null;};});jsx3.Class.defineClass("jsx3.xml.Processor",null,null,function(n,q){var
ba=jsx3.xml.Template;n.DISABLE_OUTPUT_ESCAPING=1;n.supports=function(o){return ba.supports(o);};q.init=function(r,c,o){this.SR=r;this.DP=c;this.X3=o;};q.setXML=function(d){this.SR=d;return this;};q.setXSL=function(m){this.DP=m;return this;};q.setParams=function(d){this.X3=d;return this;};q.transformToObject=function(){return this.transform(true);};q.transform=function(b){var
ha=new
ba(this.DP);if(!ha.hasError()){if(this.X3)ha.setParams(this.X3);var
qa=ha.transform(this.SR,b);if(!ha.hasError())return qa;}var
zb=ha.getError();this.Dk(zb.code,zb.description);return null;};});jsx3.xml.Entity.jsxclass.mixin(jsx3.xml.Processor.prototype,true,["getError","hasError","Dk"]);jsx3.Class.defineClass("jsx3.util.Logger",null,null,function(h,m){var
...
ub={A:"jsxtabindex",B:"alpha(opacity=",C:")",D:"filter:alpha(opacity=",E:");",F:"text",G:"jsx:///images/icons/h.png",H:"jsx:///images/icons/v.png",I:"filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",J:"', sizingMethod='scale');",K:"_jsx_",L:"disable-output-escp",M:/&lt;/g,N:"<",O:/&gt;/g,P:">",Q:/&quot;/g,R:'"',S:/&amp;/g,T:"&",U:/&([a-zA-Z_]+);/g,V:"class",W:/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,X:"&#",Y:";",Z:"jsx_image_loader",_:"none",a:' unselectable="on"',aa:"_",b:"overflow:hidden;",ba:"img",c:"body",ca:"alt",d:'<input type="text" id="_jsx3_html_b1" style="position:absolute;top:0px;left:-120px;width:100px;height:30px;padding:8px;margin:0px;"/>',da:"id",e:"beforeEnd",ea:"src",f:"_jsx3_html_b1",fa:"unshift",g:'<div id="_jsx3_html_b2" style="position:absolute;top:0px;left:-116px;width:100px;height:24px;padding:8px;"></div>',ga:"push",h:"_jsx3_html_b2",ha:/\//g,i:"string",ia:/\s+/g,j:/^<([^\s]*)([\s\S]*)\/>$/i,ja:" ",k:"<$1$2></$1>",l:"",m:"span",n:"div",o:"scroll",p:"function",q:/\-(\w)/g,r:"head",s:"undefined",t:"http://www.w3.org/1999/xhtml",u:"style",v:"type",w:"text/css",x:"media",y:"screen",z:"object"};var
...
W=P.getElementById(ub.h);if(parseInt(W.offsetWidth)>100)r.XE=1;pa.removeChild(W);}pa.removeChild(wa);}return r.XE;};r.emptyToClosed=function(c){return typeof c==ub.i?c.replace(ub.j,ub.k):c;};r.restoreScrollPosition=function(i){};r.persistScrollPosition=function(i){};r._tn=function(h){return (h.nodeName||h.tagName||ub.l).toLowerCase();};r.scrollIntoView=function(m,s,b,a){var
ob=m.parentNode;if(b==null)b=0;if(a==null)a=0;while(ob!=null){var
Za=r._tn(ob);if(Za==ub.m||Za==ub.n){var
Ba=r.getRelativePosition(ob,m);var
ra=ob.scrollLeft,H=ob.scrollTop;var
Db=ra,Kb=H;if(ob.clientWidth+Db<=Ba.L){Db=Ba.L+m.offsetWidth-ob.clientWidth+b;}else if(b&&ob.clientWidth+Db<Ba.L+m.offsetWidth)Db=Ba.L+m.offsetWidth-ob.clientWidth+b;if(Db>=Ba.L+m.offsetWidth){Db=Ba.L-b;}else if(b&&Db>Ba.L)Db=Ba.L-b;if(ob.clientHeight+Kb<=Ba.T){Kb=Ba.T+m.offsetHeight-ob.clientHeight+a;}else if(a&&ob.clientHeight+Kb<Ba.T+m.offsetHeight)Kb=Ba.T+m.offsetHeight-ob.clientHeight+a;if(Kb>=Ba.T+m.offsetHeight){Kb=Ba.T-a;}else if(a&&Kb>Ba.T)Kb=Ba.T-a;if(Db!=ra)ob.scrollLeft=Db;if(Kb!=H)ob.scrollTop=Kb;}if(ob==s)break;ob=ob.parentNode;}};r.getScrollSizeOffset=function(q,b){return b==ub.o?q:0;};r.addEventListener=function(k,e,j){k[e]=typeof j==ub.p?j:new
Function(j);};r.removeEventListener=function(g,i,n){g[i]=null;};r.removeStyle=function(f,j){j=j.replace(ub.q,function(q,m){return m.toUpperCase();});f.style.removeAttribute(j);};r.createRule=function(c,h,k){if(!k)k=document;var
I=(k.getElementsByTagName(ub.r))[0];var
Qa=typeof k.createElementNS!=ub.s?k.createElementNS(ub.t,ub.u):k.createElement(ub.u);Qa.setAttribute(ub.v,ub.w);Qa.setAttribute(ub.x,ub.y);I.appendChild(Qa);var
db=k.styleSheets[k.styleSheets.length-1];if(typeof db.addRule==ub.z)db.addRule(c,h);};r.getRuleByName=function(k){var
ia=document.styleSheets;for(var
Mb=0;Mb<ia.length;Mb++){var
Ca=ia[Mb];for(var
C=0;C<Ca.rules.length;C++)if(Ca.rules[C].selectorText+ub.l==k)return Ca.rules[C];}return null;};r.getOuterHTML=function(j){return j.outerHTML;};r.setOuterHTML=function(p,h){return p.outerHTML=h;};r.removeNode=function(h){try{h.outerHTML=ub.l;}catch(Kb){r.findElements(h,function(sa){if(sa.style)sa.style.backgroundImage=ub.l;},false,false,false,true);var
sa=h.parentNode.removeChild(h);sa.outerHTML=ub.l;}};r.setInnerText=function(k,l){return k.innerText=l;};r.insertAdjacentHTML=function(i,a,p){i.insertAdjacentHTML(a,p);return p;};r._FOCUSABLE={input:true,textarea:true,select:true,body:true,a:true,img:true,button:true,frame:true,iframe:true,object:true};r.isFocusable=function(b){return b.focus!=null&&(parseInt(b.getAttribute(ub.A))>=0||r._FOCUSABLE[r._tn(b)]);};r.updateCSSOpacity=function(j,s){j.style.filter=ub.B+(isNaN(s)?s:s*100)+ub.C;};r.getCSSOpacity=function(l){return ub.D+(isNaN(l)?l:l*100)+ub.E;};r.getRelativePosition=function(d,i){var
Aa=(i.ownerDocument.getElementsByTagName(ub.c))[0];d=d||Aa;var
C=0;var
Q=0;if(d!=i){var
tb=i.getBoundingClientRect();C=tb.left+d.scrollLeft;Q=tb.top+d.scrollTop;if(d!=Aa){var
wb=r.getRelativePosition(null,d);C=C-wb.L;Q=Q-wb.T;}else{Q=Q-i.ownerDocument.body.scrollTop;C=C-i.ownerDocument.body.scrollLeft;}}return {L:C,T:Q,W:i.offsetWidth,H:i.offsetHeight};};r.copy=function(n){window.clipboardData.setData(ub.F,n);};r.paste=function(){return window.clipboardData.getData(ub.F);};r.OG=jsx3.resolveURI(ub.G);r.R1=jsx3.resolveURI(ub.H);r.getCSSFade=function(c){return r.getCSSPNG(c?r.OG:r.R1);};r.getCSSPNG=function(l){return ub.I+l+ub.J;};r.getJSXParent=function(p,f){while(p!=null){if(p.id&&p.id.indexOf(ub.K)==0){var
Ma=f?f.getJSXById(p.id):jsx3.GO(p.id);if(Ma!=null)return Ma;}if(!p.parentNode){var
Fb=p.parentWindow||p.defaultView;p=Fb?Fb.frameElement:null;}else p=p.parentNode;}return null;};r.removeOutputEscaping=function(j){var
ma=j?[j]:[];while(ma.length>0){var
ab=ma.shift();if(ab.nodeName&&r._tn(ab)==ub.m&&ab.className==ub.L){ab.innerHTML=((((ab.innerHTML.replace(ub.M,ub.N)).replace(ub.O,ub.P)).replace(ub.Q,ub.R)).replace(ub.S,ub.T)).replace(ub.U,r.KQ);ab.removeAttribute(ub.V);}else if(ab.childNodes)ma.push.apply(ma,this.nodesToArray(ab.childNodes));}};r.removeOutputEscapingSpan=function(g){return g.replace(ub.W,function(b,h){return ((((h.replace(ub.M,ub.N)).replace(ub.O,ub.P)).replace(ub.Q,ub.R)).replace(ub.S,ub.T)).replace(ub.U,r.KQ);});};r.EE={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.KQ=function(j,c){var
Za=r.EE[c];return Za?ub.X+Za+ub.Y:j;};r.YN=ub.Z;r.loadImages=function(p){var
Lb=document.getElementById(r.YN);if(Lb==null){var
nb=(document.getElementsByTagName(ub.c))[0];if(nb){Lb=document.createElement(ub.n);Lb.id=r.YN;Lb.style.display=ub._;nb.insertBefore(Lb,nb.firstChild);}else return;}var
Ma=jsx3.$A.is(p)?p:arguments;for(var
Mb=0;Mb<Ma.length;Mb++){if(!Ma[Mb])continue;var
Cb=jsx3.resolveURI(Ma[Mb]);var
ib=r.YN+ub.aa+Cb;if(document.getElementById(ib)==null){var
Ea=document.createElement(ub.ba);Ea.setAttribute(ub.ca,ub.l);Ea.setAttribute(ub.da,ib);Ea.setAttribute(ub.ea,ub.l+Cb);Lb.appendChild(Ea);}}};r.updateRule=function(f,i,o){var
Qa=jsx3.html.getRuleByName(f);if(Qa)Qa.style[i]=o;};r.getElementById=function(l,e,s){return this.findElements(l,function(k){return k.id==e;},s,false,false,true);};r.getElementByTagName=function(f,d,m){d=d.toLowerCase();return this.findElements(f,function(b){return r._tn(b)==d;},m,false,false,true);};r.getElementsByTagName=function(f,d,m){d=d.toLowerCase();return this.findElements(f,function(b){return r._tn(b)==d;},m,true,false,true);};r.findElements=function(m,g,a,e,c,o){var
yb=a?ub.fa:ub.ga;var
bb=e?[]:null;var
y=o?[m]:this.nodesToArray(m.childNodes);while(y.length>0){var
db=y.shift();if(g.call(null,db))if(e)bb[bb.length]=db;else return db;if(!c)y[yb].apply(y,this.nodesToArray(db.childNodes));}return bb;};r.getElmUpByTagName=function(a,i,m){return r.findElementUp(a,function(o){return r._tn(o)==i;},m);};r.findElementUp=function(g,n,s){var
Qa=g.ownerDocument.documentElement;var
ta=s?g:g.parentNode;while(ta!=null){if(n.call(null,ta))return ta;if(ta==Qa)break;ta=ta.parentNode;}return null;};r.selectSingleElm=function(c,e){var
B=1,E=arguments;if(arguments.length==2)if(typeof e==ub.i){B=0;E=e.split(ub.ha);}else if(jsx3.$A.is(e)){B=0;E=e;}var
J=c;for(var
R=B;J!=null&&R<E.length;R++){var
D=E[R];if(!isNaN(D)){var
Ua=Number(D);var
Bb=J.childNodes.length;var
ra=0,Sa=0;for(;ra<Bb&&Sa<Ua;ra++)if(J.childNodes[ra].nodeType==1)Sa++;J=J.childNodes[ra];}else throw new
jsx3.Exception();}return J;};r.nodesToArray=function(n){var
O=new
Array(n.length);for(var
wb=0;wb<n.length;wb++)O[wb]=n[wb];return O;};r.getSelection=function(e){return new
r.Selection(e);};r.focusNext=function(b,n){var
ka=b;while(ka.lastChild)ka=ka.lastChild;while(!r.isFocusable(ka)&&ka!=b)ka=ka.previousSibling||ka.parentNode;if(ka!=b||r.isFocusable(ka))if(ka.onfocus!=null){var
oa=ka.onfocus;ka.onfocus=null;ka.focus();jsx3.sleep(function(){ka.onfocus=oa;});}else ka.focus();};r.focusPrevious=function(d,i){var
gb=this.findElements(d,function(c){return r.isFocusable(c);},true,false,false,true);if(gb!=null)if(gb.onfocus!=null){var
Q=gb.onfocus;gb.onfocus=null;gb.focus();jsx3.sleep(function(){gb.onfocus=Q;});}else gb.focus();};r.focus=function(f){try{if(f.focus)f.focus();}catch(Kb){}};r.addClass=function(b,f){var
Gb=b.className;if(Gb){if(!(jsx3.$A(Gb.split(ub.ia))).contains(f))b.className=Gb+ub.ja+f;}else b.className=f;};r.removeClass=function(n,i){var
pb=n.className;if(pb&&pb.indexOf(i)>=0){var
R=jsx3.$A(pb.split(ub.ia));if(R.remove(i))n.className=R.join(ub.ja);}};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(b,o){var
ub={a:"textarea",b:"EndToEnd",c:/\r\n|\r|\n/g,d:"character",e:"end"};var
Eb=jsx3.html;o.init=function(e){this.RW=(e.ownerDocument.selection.createRange()).duplicate();this.oK=e;};o.getStartIndex=function(){var
Ba=this.oK.ownerDocument.selection.createRange();var
v=null;if(Eb._tn(this.oK)==ub.a){v=Ba.duplicate();v.moveToElementText(this.oK);}else v=this.oK.createTextRange();v.setEndPoint(ub.b,Ba);return v.text.length-Ba.text.length;};o.getEndIndex=function(){var
eb=this.oK.ownerDocument.selection.createRange();var
ga=null;if(Eb._tn(this.oK)==ub.a){ga=eb.duplicate();ga.moveToElementText(this.oK);}else ga=this.oK.createTextRange();ga.setEndPoint(ub.b,eb);return ga.text.length;};o.setRange=function(s,i){var
gb=this.oK.value;var
da=ub.c;da.lastIndex=0;var
z=i;while(da.test(gb)&&da.lastIndex<=z){s=s-1;i=i-1;}var
Ja=this.oK.createTextRange();Ja.collapse(true);Ja.moveStart(ub.d,s);Ja.moveEnd(ub.d,i-s);Ja.select();};o.getOffsetLeft=function(){return this.RW.offsetLeft;};o.getOffsetTop=function(){return this.RW.offsetTop;};o.getText=function(){return this.RW.text;};o.setText=function(s){this.RW.text=s;};o.insertCaret=function(h){if(h==ub.e){this.RW.collapse();this.RW.select();}else throw new
