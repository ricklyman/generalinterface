...
ub={a:"px",b:"yp",c:"v",d:"urn:schemas-microsoft-com:vml",e:"#default#VML",f:"event",g:"number",h:"#",i:"",j:/^\s*(.*?)\s*$/,k:"$1",l:/[^\d\.]/g,m:/[^\d\.]/,n:" ",o:"on",p:/\"/g,q:"&quot;",r:/;\s*$/,s:";",t:"jsx3.GO('",u:"').",v:"(",w:",this,'",x:"');"};m._e=ub.a;m.MN=ub.b;try{if(document.documentMode>=8){document.namespaces.add(ub.c,ub.d,ub.e);m._IE8=1;}}catch(Kb){}m.Th=ub.c;m.QO=ub.f;m.colorAsHtml=function(d){return typeof d==ub.g?ub.h+((d+16777216).toString(16)).substring(1):ub.i+d;};m.xf=function(g,d,o){if(g==null)g=0;if(d==null)d=ub.a;if(typeof g==ub.g){return g+ub.i+d;}else{g=g.toString();g=g.replace(ub.j,ub.k);if(o)g=g.replace(ub.l,ub.i);return g.match(ub.m)?g:g+ub.i+d;}};m.Zj=function(f,e){return m.xf(f,ub.i,true)+ub.n+m.xf(e,ub.i,true);};m.Tb=function(s){return Math.max(0,Math.min(1,s));};m.degreesToRadians=function(d){return jsx3.util.numMod(2*Math.PI/360*(-1*d+90),2*Math.PI);};m.paintEventHandler=function(p,o,g,k){var
Ua=ub.o+o;var
E=ub.i;var
Ja=k.getProperty(Ua);if(Ja){E=Ja.replace(ub.p,ub.q);if(!Ja.match(ub.r))E=E+ub.s;}E=E+(ub.t+p.getId()+ub.u+m.MN+ub.v+m.QO+ub.w+g+ub.x);if(E.length>0)k.setProperty(Ua,E);};m.updateVector=function(i,o){o.outerHTML=i.paint();};});jsx3.Class.defineClass("jsx3.html.Tag",null,null,function(g,q){var
...
ub={a:"group",b:"xmlns:v",c:"urn:schemas-microsoft-com:vml",d:"coordsize",e:"absolute"};a.init=function(m,p,g,q){this.jsxsuper(jsx3.vector.Th,ub.a,m,p,g,q);this.setProperty(ub.b,ub.c);};a.paintUpdate=function(){this.jsxsuper();if(this.getWidth()&&this.getHeight()){this.setProperty(ub.d,jsx3.vector.Zj(parseInt(this.getWidth()),parseInt(this.getHeight())));}else this.setProperty(ub.d,jsx3.vector.Zj(100,100));if(this.getPosition()!=ub.e){this.setLeft(null);this.setTop(null);}};});jsx3.Class.defineClass("jsx3.vector.Tag",jsx3.html.BlockTag,null,function(j,a){var
ub={a:"title",b:"rotation",c:"coordsize"};a.init=function(l,g,m,d,k){this.jsxsuper(jsx3.vector.Th,l,g,m,d,k);};a.getToolTip=function(){return this.getProperty(ub.a);};a.setToolTip=function(d){this.setProperty(ub.a,d);};a.getRotation=function(){return this.getStyle(ub.b);};a.setRotation=function(b){this.setStyle(ub.b,b);};a.paintUpdate=function(){this.jsxsuper();var
tb=this.getParent();if(this.getWidth()&&this.getHeight()){this.setProperty(ub.c,jsx3.vector.Zj(parseInt(this.getWidth()),parseInt(this.getHeight())));}else this.removeProperty(ub.c);};});jsx3.Class.defineClass("jsx3.vector.Stroke",jsx3.html.Tag,null,function(m,s){var
ub={a:"stroke",b:"<stroke ",c:" ",d:"/>",e:"<",f:":",g:" id='",h:"'",i:" on='",j:" color='",k:" opacity='",l:" weight='",m:/\s+/};var
ga=jsx3.vector;m.dk=ub.a;s.init=function(p,j,h){this.jsxsuper(ga.Th,m.dk);this.VH=null;this.uW=p!=null?p:0;this.Vv=j!=null?j:1;this.jM=h!=null?ga.Tb(h):1;};s.getColor=function(){return this.uW;};s.getColorHtml=function(){return ga.colorAsHtml(this.uW);};s.setColor=function(e){this.uW=e;};s.getWidth=function(){return this.Vv;};s.setWidth=function(n){this.Vv=n;};s.getAlpha=function(){return this.jM;};s.setAlpha=function(p){this.jM=p!=null?ga.Tb(p):null;};s.onAppendChild=function(n){return false;};s.toString=function(){return ub.b+this.getColorHtml()+ub.c+this.Vv+ub.c+this.jM+ub.d;};s.paint=function(){var
qa=ub.e+ga.Th+ub.f+this.getTagName();if(this.getId()!=null)qa=qa+(ub.g+this.getId()+ub.h);var
da=this.getColorHtml();if(this.VH!=null)qa=qa+(ub.i+this.VH+ub.h);if(da!=null)qa=qa+(ub.j+da+ub.h);if(this.jM!=null&&this.jM<1)qa=qa+(ub.k+this.jM+ub.h);if(this.Vv!=null)qa=qa+(ub.l+ga.xf(this.Vv)+ub.h);qa=qa+ub.d;return qa;};s.zh=function(i,b){i[b]=this.paint();return b+1;};s.Aj=function(){return this.jM==1||this.jM==null;};m.valueOf=function(k){if(jsx3.util.strEmpty(k))return null;if(k instanceof m)return k;var
...
ub={a:"group"};k.init=function(p,s,d,a){this.jsxsuper(i.dk,p,s,d,a);};i.dk=ub.a;k.onAppendChild=function(a){return a instanceof i||a instanceof jsx3.vector.BaseShape;};});jsx3.Class.defineClass("jsx3.vector.BaseShape",jsx3.vector.Tag,null,function(a,q){var
ub={a:"shape",b:"string",c:"filled",d:"false",e:"stroked",f:"true",g:"fillcolor",h:"strokecolor",i:"strokeweight"};var
Ea=jsx3.html.Tag;var
Sa=jsx3.vector;q.init=function(s,f,c,n,d){this.jsxsuper(s!=null?s:a.dk,f,c,n,d);this.be=null;this.Pj=null;};a.dk=ub.a;q.paintUpdate=function(){var
Da=(this.getChildren()).concat();for(var
Ib=0;Ib<Da.length;Ib++)if(typeof Da[Ib]==ub.b)this.removeChild(Da[Ib]);this.jsxsuper();this.setProperty(ub.c,this.getFill()==null?ub.d:null,ub.e,this.getStroke()==null?ub.d:null);if(this.be!=null)if(this.be.Aj()){this.setProperty(ub.c,this.be.VH!=null?this.be.VH?ub.f:ub.d:null,ub.g,this.be.getColorHtml());}else{this.removeProperty(ub.c,ub.g);this.appendChild(this.be.paint());}if(this.Pj!=null)if(this.Pj.Aj()){var
Fa=this.Pj.getWidth();this.setProperty(ub.e,this.Pj.VH!=null?this.Pj.VH?ub.f:ub.d:null,ub.h,this.Pj.getColorHtml(),ub.i,Fa!=null?Sa.xf(Fa):null);}else{this.removeProperty(ub.e,ub.h,ub.i);this.appendChild(this.Pj.paint());}};q.onAppendChild=function(d){return d instanceof Sa.TextLine||d instanceof Sa.Fill||d instanceof Sa.Stroke||typeof d==ub.b;};q.setFill=function(o){this.be=o;};q.setStroke=function(b){this.Pj=b;};q.getFill=function(){return this.be;};q.getStroke=function(){return this.Pj;};});jsx3.Class.defineClass("jsx3.vector.Shape",jsx3.vector.BaseShape,null,function(k,a){var
ub={a:"path",b:"t",c:"m",d:" ",e:"r",f:"l",g:"wa",h:"at",i:"x"};var
ga=jsx3.vector;a.getPath=function(){this.Zz();return this.getProperty(ub.a);};a.setPath=function(q){this._p=[q];this.setProperty(ub.a,q);};a.pathMoveTo=function(l,j,c){this.Uw((c?ub.b:ub.c)+ub.d+l+ub.d+j);return this;};a.pathLineTo=function(l,s,c){this.Uw((c?ub.e:ub.f)+ub.d+l+ub.d+s);return this;};a.pathArcTo=function(b,j,l,s,i,r,h,q,f){this.Uw((f?ub.g:ub.h)+ub.d+(b-l)+ub.d+(j-s)+ub.d+(b+l)+ub.d+(j+s)+ub.d+i+ub.d+r+ub.d+h+ub.d+q);return this;};a.pathClose=function(){this.Uw(ub.i);return this;};a.Uw=function(n){if(!this._p)this._p=[];this._p.push(n);};a.Zz=function(){if(this._p&&this._p.length>1){var
Ca=this._p.join(ub.d);this.setPath(Ca);}};a.paintUpdate=function(){this.Zz();this.jsxsuper();};});jsx3.Class.defineClass("jsx3.vector.Line",jsx3.vector.BaseShape,null,function(k,n){var
...
Hb=Math.max(j,Math.max(m,l))-Math.min(j,Math.min(m,l));this.jsxsuper(ub.a,g,j,Math.max(Lb,16),Math.max(Hb,16));this.fD=f;this.A4=m;this.zQ=e;this.Bt=l;};n.setPoints=function(c,j,b,i){this.fD=c;this.A4=j;this.zQ=b;this.Bt=i;var
U=this.getLeft();var
ib=this.getTop();var
Lb=Math.max(U,Math.max(c,b))-Math.min(U,Math.min(c,b));var
sb=Math.max(ib,Math.max(j,i))-Math.min(ib,Math.min(j,i));this.setWidth(Lb);this.setHeight(sb);};n.getX1=function(){return this.fD;};n.setX1=function(s){this.fD=s;};n.getY1=function(){return this.A4;};n.setY1=function(d){this.A4=d;};n.getX2=function(){return this.zQ;};n.setX2=function(c){this.zQ=c;};n.getY2=function(){return this.Bt;};n.setY2=function(i){this.Bt=i;};n.paintUpdate=function(){this.jsxsuper();this.removeProperty(ub.b);this.setProperty(ub.c,jsx3.vector.Zj(this.fD,this.A4),ub.d,jsx3.vector.Zj(this.zQ,this.Bt));};n.toString=function(){return ub.e+this.getId()+ub.f+this.getX1()+ub.g+this.getY1()+ub.h+this.getX2()+ub.g+this.getY2()+ub.i;};});jsx3.Class.defineClass("jsx3.vector.Rectangle",jsx3.vector.BaseShape,null,function(r,i){var
...
ub={a:"oval",b:"coordsize"};b.init=function(p,s,d,k){this.jsxsuper(a.dk,p,s,d,k);};a.dk=ub.a;b.paintUpdate=function(){this.jsxsuper();this.removeProperty(ub.b);};});jsx3.Class.defineClass("jsx3.vector.Polygon",jsx3.vector.BaseShape,null,function(r,o){var
...
bb(G.Th,ub.d);this.Ur.setProperty(ub.e,ub.f);this.nM=new
bb(G.Th,ub.a);this.nM.setProperty(ub.g,ub.f);this.eI=new
bb(G.Th,ub.h);this.eI.setProperty(ub.e,ub.i);this.setText(a);};var
ab=ub.j;var
...
Ca=this.Ur.getStyle(ub.x);if(Ca==null){if(Ua==null)Ua=Aa.getStyleClass(ub.v+this.getClassName())||Number(0);if(Ua)Ca=Ua.textAlign;}if(Ca)this.setTextAlign(Ca);}this.jsxsuper();this.setProperty(ub.y,this.getFill()==null?ub.i:ub.f,ub.z,this.getStroke()==null?null:ub.f);if(this.Ur.getParent()==null)this.appendChild(this.Ur);if(this.nM.getParent()==null)this.appendChild(this.nM);if(this.getStroke()==null){if(this.eI.getParent()==null)this.appendChild(this.eI);}else this.removeChild(this.eI);};});jsx3.Class.defineClass("jsx3.vector.LineGroup",jsx3.vector.Shape,null,function(n,m){var
...
jsx3.vector.Canvas();};r.paint=function(){if(this.RN==null)this.createVector();return this.RN.paint();};r.repaint=function(){if(!this.RN||!this.updateVector(this.RN))this.createVector();return this.jsxsuper();};r.paintEventHandler=function(m,e,i){if(i==null)i=this.getCanvas();jsx3.vector.paintEventHandler(this,m,e,i);};r.zd=function(d){if(this.getParent()&&(d==null||isNaN(d.parentwidth)||isNaN(d.parentheight))){d=(this.getParent()).Id(this);}else if(d==null)d={};var
...
jsx3.gui.Painted.Box(d);};r.Hj=function(n,k,d){if(k){var
