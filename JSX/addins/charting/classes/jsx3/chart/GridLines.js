...
tb=this.Ep(l);if(q!=null){var
T=q.jg();if(T.length==0||tb==1)this.wE(o,0,0,g,c,this.H5(l,0));if(T.length>0){if(tb>1)this.GL(o,q,T,l,null,e);this.BE(o,q,T,n,null,e);this.uO(o,q,T,j,e);}}else this.wE(o,0,0,g,c,this.H5(l,0));};i.GL=function(j,c,m,g,h,n){if(h==null)h=new
Array(this.Ep(g));if(h.length==0)return;var
Kb=j.getHeight();var
Ha=j.getWidth();var
O=n?Kb:Ha;var
ta=n?Ha:Kb;for(var
...
xb.RectangleGroup(0,0,Ha,Kb);B.setFill(this.H5(g,Va));j.appendChild(B);}if(Va==m.length){if(m[Va-1]<O)this.Uv(B,m[Va-1],0,O,ta,n);}else if(Va==0){if(m[Va]>0)this.Uv(B,0,0,m[Va],ta,n);}else this.Uv(B,m[Va-1],0,m[Va],ta,n);}};i.Uv=function(q,e,l,d,k,c){if(c)q.addRectangle(l,e,k,d);else q.addRectangle(e,l,d,k);};i.BE=function(j,c,m,b,h,n){if(h==null)h=new
Array(this.Ep(b));if(h.length==0)return;var
Za=j.getHeight();var
Ga=j.getWidth();for(var
Ab=0;Ab<m.length;Ab++){var
jb=h[Ab%h.length];if(jb==null){jb=h[Ab%h.length]=new
xb.LineGroup(0,0,Ga,Za);jb.setStroke(this.ZH(b,Ab));j.appendChild(jb);}if(n)jb.addRelativeLine(0,m[Ab],Ga,0);else jb.addRelativeLine(m[Ab],0,0,Za);}};i.uO=function(h,e,k,s,l){var
Ta=this.Ep(s);if(Ta==0)return;var
da=new
Array(Ta);for(var
pb=0;pb<k.length;pb++){var
Ja=e.Gl(k,pb);this.BE(h,e,Ja,s,da,l);}};i.wE=function(q,m,e,b,l,d,s){if(d!=null){var
Q=new
xb.Rectangle(m,e,b,l);if(s!=null)Q.setZIndex(s);Q.setFill(d);q.appendChild(Q);}};i.H5=function(j,m){if(j==null)return null;if(jsx3.$A.is(j)){if(j.length>0){return xb.Fill.valueOf(j[m%j.length]);}else return null;}else return xb.Fill.valueOf(j);};i.ZH=function(d,s){if(d==null)return null;if(jsx3.$A.is(d)){if(d.length>0){return V.valueOf(d[s%d.length]);}else return null;}else return V.valueOf(d);};i.Ep=function(k){if(k==null)return 0;return jsx3.$A.is(k)?k.length:1;};i.onSetChild=function(){return false;};i.onSetParent=function(n){return jsx3.chart.Chart&&n instanceof jsx3.chart.Chart;};a.getVersion=function(){return jsx3.chart.Xe;};});
