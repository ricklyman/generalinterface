...
jsx3.IllegalArgumentException(ub.d,c);};d.getXRange=function(f){return this.getRangeForField(f,ub.e);};d.getYRange=function(q){return this.getRangeForField(q,ub.f);};d.createVector=function(){this.jsxsuper();this.QY();};d.QY=function(){var
ob=this.wf();var
Ta=this.zf();var
Ia=this.bh();var
...
Hb=Ta[yb];Hb.ym();for(var
lb=0;lb<Ia.length;lb++){var
Pa=Ia[lb];var
U=Hb.getXValue(Pa);var
t=Hb.getYValue(Pa);if(U==null||t==null)continue;U=Ra.getCoordinateForNoClip(U);t=jb.getCoordinateForNoClip(t);if(Hb instanceof jsx3.chart.PointSeries){Hb.uk(Pa,lb,U,t);}else{var
fa=Hb.getMagnitudeValue(Pa);if(fa!=null)Hb.uk(Pa,lb,U,t,fa);}}Hb.updateView();ob.appendChild(Hb.getCanvas());}};d.rl=function(s){return s instanceof jsx3.chart.PlotSeries;};p.getVersion=function(){return jsx3.chart.Xe;};});
