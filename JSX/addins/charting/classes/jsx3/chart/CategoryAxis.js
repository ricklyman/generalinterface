...
nb=this.md(ub.f);if(nb!=null)return nb;var
B=this.md(ub.c);nb=[];if(B<1)return nb;var
...
B=this.md(ub.c);if(this.tickAlignment==ub.b){var
Ab=this.jg();var
Xa=[];for(var
