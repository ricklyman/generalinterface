...
Ma=Ib.getXValue(ja);if(Ma!=null)jb=tb.getCoordinateForNoClip(Ma);}else if(jsx3.chart.isCategoryAxis(tb))jb=tb.getPointForCategory(bb);if(jb!=null&&cb!=null)Ib.uk(ja,jb,cb,bb);else Ib.am(ja,jb,cb,bb);}Ib.updateView();T.appendChild(Ib.getCanvas());}};n.kg=function(){return this.type==ub.b||this.type==ub.c;};n.rl=function(p){return p instanceof jsx3.chart.LineSeries;};e.getVersion=function(){return jsx3.chart.Xe;};});
