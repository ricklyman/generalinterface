...
ab=kb.getXValue(Z);if(ab!=null)I=Na.getCoordinateForNoClip(ab);}else if(jsx3.chart.isCategoryAxis(Na))I=Na.getPointForCategory(W);if(I==null)continue;kb.uk(Z,I,nb,W);kb.Bh(I,xb);}kb.updateView();Fb.appendChild(kb.getCanvas());}};q.kg=function(){return this.type==ub.b||this.type==ub.c;};q.rl=function(h){return h instanceof jsx3.chart.AreaSeries;};r.getVersion=function(){return jsx3.chart.Xe;};});
