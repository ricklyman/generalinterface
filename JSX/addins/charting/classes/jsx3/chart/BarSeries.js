...
Q=this.md(ub.a);if(Q==null){Q=[];this.Rf(ub.a,Q);}return Q;};d.updateView=function(){this.jsxsuper();var
sa=this.Gk();var
...
fa=Ma!=null?Ma.apply(this,[e,o]):this.md(ub.b);H.setFill(fa);H.setStroke(this.md(ub.c));var
...
ca=this._getShownAreas();ca.splice(0,ca.length);};d.getXField=function(){return this.xField;};d.setXField=function(q){this.xField=q;};d.getYField=function(){return this.yField;};d.setYField=function(k){this.yField=k;};d.getMinField=function(){return this.minField;};d.setMinField=function(j){this.minField=j;};l.getVersion=function(){return jsx3.chart.Xe;};});jsx3.chart.BCSeries.prototype.drawBar=jsx3.chart.BCSeries.prototype.Nm;jsx3.chart.BCSeries.prototype.drawColumn=jsx3.chart.BCSeries.prototype.Nm;jsx3.Class.defineClass("jsx3.chart.BarSeries",jsx3.chart.BCSeries,null,function(k,a){var
