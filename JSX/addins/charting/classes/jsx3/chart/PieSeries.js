...
ub={a:"bottom",b:"jsx3.chart.PieSeries.tooltip",c:"labelPlacement",d:"un",e:"_s",f:"jsxid",g:"top",h:"right",i:"left",j:", ",k:"%"};var
...
jsx3.IllegalArgumentException(ub.c,g);};h.getLabelOffset=function(){return this.labelOffset!=null?this.labelOffset:0;};h.setLabelOffset=function(d){this.labelOffset=Math.round(d);};h.hd=function(m,d){var
ia=this.getColors();if(ia!=null&&ia.length>0)return G.Fill.valueOf(ia[d%ia.length]);var
D=this.getColorFunction();if(D!=null)return D.apply(this,[m,d]);var
x=this.getChart();if(x!=null)return x.hd(m,d);return new
G.Fill();};h.Ys=function(s){if(this.stroke)return G.Stroke.valueOf(this.stroke);var
Za=this.getChart();if(Za!=null){var
sb=Za.getSeriesStroke();if(sb)return G.Stroke.valueOf(sb);}return null;};h.qd=function(m,e,d,l,c,q,r,f){var
H=this.md(ub.d);if(H==null){H=[];this.Rf(ub.d,H);}H.push([m,e,d,l,c,q,r,f]);};h.Wm=function(){this.qd(null);};h.Tj=function(){var
T=this.md(ub.d);if(T!=null)T.splice(0,T.length);};h.updateView=function(){this.jsxsuper();var
ob=this.getCanvas();var
hb=ob.getWidth();var
Ya=ob.getHeight();var
ba=this.md(ub.d);if(ba==null)return;var
...
U=ba[Y][7];var
tb=new
G.Shape(null,0,0,hb,Ya);tb.setId(this.getId()+ub.e+Y);ob.appendChild(tb);tb.setFill(this.hd(ha,Y));tb.setStroke(this.Ys(Y));this.Ci(tb,Y,ha.getAttribute(ub.f));var
...
Ga=Math.round(-1*Qa*Math.sin(C))+S;tb.pathLineTo(Na,Ga);if(Mb||Ja!=Na||fb!=Ga)tb.pathArcTo(pb,S,Qa,Qa,Na,Ga,Ja,fb,true);}else if(!Mb)tb.pathLineTo(pb,S);tb.pathClose();if(N!=null)tb.setToolTip(N.apply(this,[this,ha,U]));}var
...
ha=k.getValue(o);return ha+ub.j+Math.round(d*10)/10+ub.k;};i.getVersion=function(){return jsx3.chart.Xe;};});
