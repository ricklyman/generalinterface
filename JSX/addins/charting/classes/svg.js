...
ub={a:".benchmark",b:"top",c:"right",d:"bottom",e:"left",f:/\s*[,;]\s*/,g:"",h:"number",i:/\s+/,j:" ",k:"gradient",l:"_",m:"_eval",n:"object",o:"var f = ",p:"; f;",q:"error evaluating '",r:"', ",s:" is not of type ",t:"error evaluating ",u:" field '",v:"function",w:/\S/,x:"doSpyOver",y:"doSpyOut",z:"string"};n.Xe=n.ADDIN.getVersion();n.LOG=jsx3.util.Logger.getLogger(n.jsxpackage.getName());n.LOG_BENCH=jsx3.util.Logger.getLogger(n.jsxpackage.getName()+ub.a);n.t7={};n.QTOP=ub.b;n.QRIGHT=ub.c;n.QBOTTOM=ub.d;n.QLEFT=ub.e;n.splitBox=function(f,i,p,j,l,g,c){var
...
P=new
jsx3.vector.Fill(f.getColor(),f.getAlpha());P.setType(ub.k);P.setColor2(cb[0]);P.setAngle(cb[1]);P.setAlpha2(cb[2]);P.setColors(cb[3]);return P;}else return f;};n.yd=function(d,g,m){d[g]=m;d[ub.l+g+ub.m]=null;};n.Sl=function(g,d,b){if(b==null)b=ub.n;var
db=ub.l+d+ub.m;if(!g[db]&&g[d])try{var
Va=g.eval(ub.o+g[d]+ub.p);g[db]=Va;if(typeof g[db]!=b){n.LOG.error(ub.q+d+ub.r+g[db]+ub.s+b);g[db]=n.t7;}}catch(Kb){Kb=jsx3.NativeError.wrap(Kb);g[db]=n.t7;n.LOG.error(ub.t+b+ub.u+d,Kb);}return g[db]!=n.t7?g[db]:null;};n.Ul=function(l,r){if(typeof l[r]==ub.v)return l[r];return n.Sl(l,r,ub.v);};n.Ud=function(q,p){var
...
jsx3.vector.Stroke();m.setStroke(Ra);}Ra.setColor(I);if(typeof a.getBorderAlpha==ub.v)Ra.setAlpha(a.getBorderAlpha());if(typeof a.getBorderWidth==ub.v)Ra.setWidth(a.getBorderWidth());}else m.setStroke(null);};n.Ci=function(b,h){var
...
ub={A:"');",a:"px",b:"yp",c:"http://www.w3.org/2000/svg",d:"evt",e:"number",f:"#",g:"",h:/^\s*(.*?)\s*$/,i:"$1",j:/[^\d\.]/g,k:/[^\d\.]/,l:"on",m:"_",n:"onclick",o:"if(evt.detail%2==0){if(this.getAttribute('_dblclick'))jsx3.GO('",p:"').",q:"(evt,this,this.getAttribute('_dblclick'));}",r:"else{if(this.getAttribute('_click'))",s:"jsx3.GO('",t:"(evt,this,this.getAttribute('_click'));}",u:/\"/g,v:"&quot;",w:/;\s*$/,x:";",y:"(",z:",this,'"};m._e=ub.a;m.MN=ub.b;m.Th=ub.c;m.QO=ub.d;m.colorAsHtml=function(a){return typeof a==ub.e?ub.f+((a+16777216).toString(16)).substring(1):ub.g+a;};m.xf=function(a,j,i){if(a==null)a=0;if(j==null)j=ub.a;if(typeof a==ub.e){return a+ub.g+j;}else{a=a.toString();a=a.replace(ub.h,ub.i);if(i)a=a.replace(ub.j,ub.g);return a.match(ub.k)?a:a+ub.g+j;}};m.Tb=function(s){return Math.max(0,Math.min(1,s));};m.degreesToRadians=function(b){return jsx3.util.numMod(2*Math.PI/360*(-1*b+90),2*Math.PI);};m.paintEventHandler=function(o,n,f,j){var
Ta=ub.l+n;var
Eb=ub.g;if(n==jsx3.gui.Event.DOUBLECLICK||n==jsx3.gui.Event.CLICK){j.setProperty(ub.m+n,f);var
Kb=j.getProperty(ub.n);if(Kb){}j.setProperty(ub.n,ub.o+o.getId()+ub.p+m.MN+ub.q+ub.r+ub.s+o.getId()+ub.p+m.MN+ub.t);return;}var
Ea=j.getProperty(Ta);if(Ea){Eb=Ea.replace(ub.u,ub.v);if(!Ea.match(ub.w))Eb=Eb+ub.x;}Eb=Eb+(ub.s+o.getId()+ub.p+m.MN+ub.y+m.QO+ub.z+f+ub.A);if(Eb.length>0)j.setProperty(Ta,Eb);};m.updateVector=function(a,d){var
...
ub={A:"/>",B:"#",a:":",b:"can't append ",c:" to ",d:", already has parent ",e:"Illegal to append child ",f:" to parent ",g:".",h:"class",i:"id",j:";",k:"Error appending '",l:"' to 'cssText': ",m:"dC",n:"ys",o:"",p:"Error setting style '",q:"' to '",r:"': ",s:/^<\?import .*?\/>/,t:/^<(\w+(\:\w+)?)\b/,u:"<",v:/\b([_a-zA-Z]\w*)=([^\s\"]+) /g,w:'$1="$2" ',x:"</",y:">",z:"string"};var
Ka=jsx3.Exception;g.c7=[];q.u9=null;q.Zr=null;if(jsx3.CLASS_LOADER.VML){q.init=function(e,m){this.u9=m;this.Zr=e;this.Ni=document.createElement(e?e+ub.a+m:m);this.dC=null;this.ys=null;};q.appendChild=function(c){if(this.onAppendChild(c)){if(c instanceof g&&c.getParent()!=null)throw new
Ka(ub.b+c+ub.c+this+ub.d+c.dC);if(this.ys==null)this.ys=[];this.ys.push(c);c.dC=this;}else throw new
Ka(ub.e+c+ub.f+this+ub.g);};q.removeChild=function(d){if(this.ys){var
Pa=jsx3.util.arrIndexOf(this.ys,d);if(Pa>=0){this.ys[Pa].dC=null;this.ys.splice(Pa,1);}}};q.replaceChild=function(h,i){if(this.ys){var
I=jsx3.util.arrIndexOf(this.ys,i);if(I>=0){this.ys[I].dC=null;this.ys[I]=h;h.dC=this;}}};q.removeChildren=function(){if(this.ys)this.ys.splice(0,this.ys.length);};q.getClassName=function(){return this.Ni.className;};q.setClassName=function(n){this.Ni.className=n;};}else if(jsx3.CLASS_LOADER.SVG){q.init=function(e,o){this.u9=o;this.Zr=e;if(o)this.Ni=e?document.createElementNS(e,o):document.createElement(o);this.dC=null;this.ys=null;};q.appendChild=function(k){if(this.onAppendChild(k)){if(k instanceof g&&k.getParent()!=null)throw new
Ka(ub.b+k+ub.c+this+ub.d+k.dC);if(this.ys==null)this.ys=[];this.ys.push(k);k.dC=this;this.Ni.appendChild(k.Ni);}else throw new
Ka(ub.e+k+ub.f+this+ub.g);};q.removeChild=function(d){if(this.ys){var
ob=jsx3.util.arrIndexOf(this.ys,d);if(ob>=0){this.ys[ob].dC=null;this.ys.splice(ob,1);}}this.Ni.removeChild(d.Ni);};q.replaceChild=function(j,e){if(this.ys){var
Oa=jsx3.util.arrIndexOf(this.ys,e);if(Oa>=0){this.ys[Oa].dC=null;this.ys[Oa]=j;j.dC=this;}}this.Ni.replaceChild(j.Ni,e.Ni);};q.removeChildren=function(){if(this.ys)this.ys.splice(0,this.ys.length);var
ya=this.Ni.childNodes;for(var
nb=ya.length-1;nb>=0;nb--)this.Ni.removeChild(ya[nb]);};q.getClassName=function(){return this.getProperty(ub.h);};q.setClassName=function(s){this.setProperty(ub.h,s);};}q.getParent=function(){return this.dC;};q.getChildren=function(){return this.ys==null?g.c7:this.ys;};q.getId=function(){return this.Ni.id;};q.setId=function(h){this.setProperty(ub.i,h);};q.setExtraStyles=function(f){try{this.Ni.style.cssText+=(ub.j+f);}catch(Kb){throw new
Ka(ub.k+f+ub.l+jsx3.NativeError.wrap(Kb));}};q.release=function(){delete this[ub.m];if(this.ys){for(var
oa=this.ys.length-1;oa>=0;oa--)if(this.ys[oa].release)this.ys[oa].release();delete this[ub.n];}};q.onAppendChild=function(d){return true;};q.onRemoveChild=function(f){return true;};q.setProperty=function(h,f){var
...
zb=[];var
Va=this.zh(zb,0);return (zb.slice(0,Va)).join(ub.o);};q.zh=function(n,p){var
X=this.ys;var
Y=jsx3.html.getOuterHTML(this.Ni);var
va=ub.o;if(jsx3.vector._IE8){Y=Y.replace(ub.s,ub.o);va=jsx3.vector.Th+ub.a+this.Ni.nodeName;}else{Y=Y.replace(ub.t,function(o,f){va=f;return ub.u+va.toLowerCase();});Y=Y.replace(ub.v,ub.w);}var
Ha=Y.lastIndexOf(ub.x);if(Ha>=0&&(Y.substring(Ha)).indexOf(va)!=2)Ha=-1;if(X!=null&&X.length>0){var
la=null,U=null;if(Ha>=0){la=Y.substring(0,Ha);U=Y.substring(Ha);}else{la=Y;U=ub.x+va.toLowerCase()+ub.y;}n[p++
]=la;for(var
rb=0;rb<X.length;rb++){var
T=X[rb];if(typeof T==ub.z)n[p++
]=T;else p=T.zh(n,p);}n[p++
]=U;}else{if(Ha>=0)n[p++
]=Y.substring(0,Ha-1);else n[p++
]=Y.substring(0,Y.length-1);n[p++
]=ub.A;}return p;};}else if(jsx3.CLASS_LOADER.SVG)q.paintDom=function(){this.paintUpdate();return this.Ni;};q.paintUpdate=function(){var
Bb=this.ys;if(Bb)for(var
lb=0;lb<Bb.length;lb++)Bb[lb].paintUpdate();};q.toString=function(){return ub.u+this.getTagName()+ub.B+this.getId()+ub.A;};q.getFirstChildOfType=function(r){if(typeof r==ub.z)r=(jsx3.Class.forName(r)).getConstructor();if(this.ys){var
B=this.ys;for(var
ea=0;ea<B.length;ea++)if(B[ea] instanceof r)return B[ea];}return null;};});jsx3.Class.defineClass("jsx3.html.Text",jsx3.html.Tag,null,function(q,g){var
ub={a:"",b:'[jsx3.html.Text "',c:'"]'};if(jsx3.CLASS_LOADER.VML){g.init=function(s){this.Ny=s;};g.zh=function(n,p){n[p]=this.Ny;return p+1;};g.getText=function(){return this.Ny;};g.setText=function(m){this.Ny=m;};g.paint=function(){return this.Ny;};}else if(jsx3.CLASS_LOADER.SVG){g.init=function(f){this.Ni=document.createTextNode(f!=null?f:ub.a);};g.getText=function(){return this.Ni.nodeValue;};g.setText=function(d){this.Ni.nodeValue=d;};}g.onAppendChild=function(f){return false;};g.toString=function(){return ub.b+this.getText()+ub.c;};});jsx3.Class.defineClass("jsx3.html.BlockTag",jsx3.html.Tag,null,function(b,l){var
...
Qa=this.getStyle(ub.h);return Qa!=null?parseInt(Qa):null;};l.setHeight=function(c){this.ZW(ub.h,c);};l.getMargin=function(){return this.getStyle(ub.i);};l.setMargin=function(f){this.setStyle(ub.i,f);};l.getPadding=function(){return this.getStyle(ub.j);};l.setPadding=function(k){this.setStyle(ub.j,k);};l.getPosition=function(){return this.getStyle(ub.k);};l.setPosition=function(o){this.setStyle(ub.k,o);};l.getZIndex=function(){return this.getStyle(ub.l);};l.setZIndex=function(q){this.setStyle(ub.l,q);};l.getBackgroundColor=function(){return this.getStyle(ub.m);};l.setBackgroundColor=function(n){this.setStyle(ub.m,n);};l.getMarginDimensions=function(){return b.Re(this.getMargin());};l.getPaddingDimensions=function(){return b.Re(this.getPadding());};b.Re=function(p){if(p)if(typeof p==ub.n){return [p,p,p,p];}else{var
...
ub={a:"svg",b:"version",c:"1.1",d:"baseProfile",e:"full",f:"xmlns:xlink",g:"http://www.w3.org/1999/xlink",h:"absolute",i:"defs",j:"width",k:"number",l:"px",m:"height"};a.init=function(g,j,m,k){this.jsxsuper(jsx3.vector.Th,ub.a,g,j,m,k);this.setProperty(ub.b,ub.c,ub.d,ub.e,ub.f,ub.g);};a.paintUpdate=function(){this.jsxsuper();if(this.d3!=null&&this.d3.getParent()==null)this.appendChild(this.d3);if(this.getPosition()!=ub.h){this.setLeft(null);this.setTop(null);}};a.getDefs=function(){if(this.d3==null){this.d3=new
jsx3.html.Tag(jsx3.vector.Th,ub.i);this.appendChild(this.d3);}return this.d3;};a.setWidth=function(d){this.jsxsuper(d);this.setProperty(ub.j,typeof d==ub.k?d+ub.l:d);};a.setHeight=function(g){this.jsxsuper(g);this.setProperty(ub.m,typeof g==ub.k?g+ub.l:g);};});jsx3.Class.defineClass("jsx3.vector.Tag",jsx3.html.BlockTag,null,function(j,a){var
ub={a:"title",b:"can't append ",c:" to ",d:", already has parent ",e:"Illegal to append child ",f:" to parent ",g:"."};a.init=function(l,g,m,d,k){this.jsxsuper(jsx3.vector.Th,l,g,m,d,k);};a.getToolTip=function(){return this.getProperty(ub.a);};a.setToolTip=function(d){this.setProperty(ub.a,d);};a.setRotation=function(p){this.cM=p;};a.setLeft=function(c){this.J2=c;};a.setTop=function(d){this.PS=d;};a.setWidth=function(m){this.Vv=m;};a.setHeight=function(l){this.rz=l;};a.setPosition=function(k){this.cQ=k;};a.getRotation=function(){return this.cM;};a.getLeft=function(){return this.J2;};a.getTop=function(){return this.PS;};a.getWidth=function(){return this.Vv;};a.getHeight=function(){return this.rz;};a.getPosition=function(){return this.cQ;};a.setZIndex=function(q){this.jsxsuper(q);var
...
jsx3.Exception(ub.b+g+ub.c+this+ub.d+g.dC);if(this.ys==null)this.ys=[];if(g instanceof j){var
ja=parseInt(g.getZIndex());if(!isNaN(ja))for(var
Qa=0;Qa<this.ys.length;Qa++){var
Wa=this.ys[Qa];var
qa=parseInt(Wa.getZIndex());if(ja<qa)this.Ni.insertBefore(g.Ni,Wa.Ni);}}if(g.Ni.parentNode==null)this.Ni.appendChild(g.Ni);this.ys.push(g);g.dC=this;}else throw new
...
ga=jsx3.vector;m.dk=null;s.init=function(p,j,h){this.jsxsuper(ga.Th,m.dk);this.VH=null;this.uW=p!=null?p:0;this.Vv=j!=null?j:1;this.jM=h!=null?ga.Tb(h):1;};s.getColor=function(){return this.uW;};s.getColorHtml=function(){return ga.colorAsHtml(this.uW);};s.setColor=function(e){this.uW=e;};s.getWidth=function(){return this.Vv;};s.setWidth=function(n){this.Vv=n;};s.getAlpha=function(){return this.jM;};s.setAlpha=function(p){this.jM=p!=null?ga.Tb(p):null;};s.onAppendChild=function(n){return false;};s.toString=function(){return ub.a+this.getColorHtml()+ub.b+this.Vv+ub.b+this.jM+ub.c;};s.paint=function(){var
qa=ub.d+ga.Th+ub.e+this.getTagName();if(this.getId()!=null)qa=qa+(ub.f+this.getId()+ub.g);var
da=this.getColorHtml();if(this.VH!=null)qa=qa+(ub.h+this.VH+ub.g);if(da!=null)qa=qa+(ub.i+da+ub.g);if(this.jM!=null&&this.jM<1)qa=qa+(ub.j+this.jM+ub.g);if(this.Vv!=null)qa=qa+(ub.k+ga.xf(this.Vv)+ub.g);qa=qa+ub.c;return qa;};s.Aj=function(){return this.jM==1||this.jM==null;};m.valueOf=function(a){if(jsx3.util.strEmpty(a))return null;if(a instanceof m)return a;var
...
ga=jsx3.vector;c.dk=null;b.init=function(e,m){this.jsxsuper(ga.Th,c.dk);this.VH=null;this.uW=e!=null?e:0;this.jM=m!=null?ga.Tb(m):1;this.Tr=null;this.B9=null;this.B0=null;this.j3=null;this.ZU=null;};b.getColor=function(){return this.uW;};b.getColorHtml=function(){return ga.colorAsHtml(this.uW);};b.setColor=function(s){this.uW=s;};b.getAlpha=function(){return this.jM;};b.setAlpha=function(l){this.jM=l!=null?ga.Tb(l):null;};b.getType=function(){return this.Tr;};b.setType=function(g){this.Tr=g;};b.getColor2=function(){return this.B9;};b.getColor2Html=function(){return ga.colorAsHtml(this.B9);};b.setColor2=function(n){this.B9=n;};b.getAlpha2=function(){return this.B0;};b.setAlpha2=function(m){this.B0=m;};b.getAngle=function(){return this.j3;};b.setAngle=function(l){this.j3=l;};b.getColors=function(){return this.ZU;};b.setColors=function(l){this.ZU=l;};b.toString=function(){return ub.a+this.getColorHtml()+ub.b+this.getAlpha()+ub.c;};b.hasGradient=function(){return this.Tr&&this.Tr!=ub.d;};b.Aj=function(){return (this.jM==1||this.jM==null)&&!this.hasGradient();};c.valueOf=function(n){if(jsx3.util.strEmpty(n))return null;if(n instanceof c)return n;var
...
ub={a:"g",b:"transform",c:"translate(",d:",",e:")"};k.init=function(p,s,d,a){this.jsxsuper(i.dk,p,s,d,a);};i.dk=ub.a;k.paintUpdate=function(){this.jsxsuper();var
...
Sa=jsx3.vector;q.init=function(s,f,c,n,d){this.jsxsuper(s!=null?s:a.dk,f,c,n,d);this.be=null;this.Pj=null;};a.dk=ub.a;q.paintUpdate=function(){this.jsxsuper();if(this.be!=null){if(this.be.hasGradient()){var
rb=this;var
ya;while(!(ya=rb.getId()))rb=rb.getParent();var
Hb=ub.b+ya;if(this.GR!=null&&this.GR.getParent()!=null)(this.GR.getParent()).removeChild(this.GR);this.setProperty(ub.c,ub.d+Hb+ub.e);this.removeProperty(ub.f);this.GR=new
Ea(Sa.Th,ub.g);this.GR.setId(Hb);var
na=this.be.getAngle()||Number(0);var
va=jsx3.util.numMod(2*Math.PI/360*(-1*na-90),2*Math.PI);var
eb=Math.cos(va);var
N=Math.sin(va);var
F=Math.max(Math.abs(eb),Math.abs(N));N=N/F;eb=eb/F;this.GR.setProperty(ub.h,jsx3.util.numRound(0.5-eb/2,1.0E-4),ub.i,jsx3.util.numRound(0.5-N/2,1.0E-4),ub.j,jsx3.util.numRound(0.5+eb/2,1.0E-4),ub.k,jsx3.util.numRound(0.5+N/2,1.0E-4));var
Ib=this.getRotation();if(Ib)this.GR.setProperty(ub.l,ub.m+-Ib+ub.e);var
Jb=new
Ea(Sa.Th,ub.n);Jb.setProperty(ub.o,ub.p,ub.q,this.be.getColorHtml(),ub.r,this.be.getAlpha());this.GR.appendChild(Jb);var
...
U=new
Ea(Sa.Th,ub.n);U.setProperty(ub.o,Ka+ub.u,ub.q,Fa[1]);this.GR.appendChild(U);}}}}var
hb=new
Ea(Sa.Th,ub.n);hb.setProperty(ub.o,ub.v,ub.q,this.be.getColor2Html(),ub.r,this.be.getAlpha2()!=null?this.be.getAlpha2():1);this.GR.appendChild(hb);(this.getDefs()).appendChild(this.GR);}else this.setProperty(ub.c,this.be.getColorHtml(),ub.f,this.be.getAlpha());}else{this.setProperty(ub.c,ub.w);this.removeProperty(ub.f);if(this.GR!=null&&this.GR.getParent()!=null)(this.GR.getParent()).removeChild(this.GR);}if(this.Pj!=null){var
z=this.Pj.getWidth();this.setProperty(ub.x,this.Pj.getColorHtml(),ub.y,z||Number(1),ub.z,this.Pj.getAlpha());}else{this.setProperty(ub.x,ub.w);this.removeProperty(ub.y,ub.z);}var
Cb=[];var
wb=this.getLeft()||Number(0);var
Mb=this.getTop()||Number(0);if(wb||Mb)Cb.push(ub.A+wb+ub.B+Mb+ub.e);var
Ib=this.getRotation();if(Ib)Cb.push(ub.m+Ib+ub.B+Math.round(this.getWidth()/2)+ub.B+Math.round(this.getHeight()/2)+ub.e);this.setProperty(ub.C,Cb.length>0?Cb.join(ub.D):null);};q.onAppendChild=function(j){return j instanceof Sa.TextLine||j instanceof Sa.Fill||j instanceof Sa.Stroke||typeof j==ub.E;};q.setFill=function(i){this.be=i;};q.setStroke=function(d){this.Pj=d;};q.getFill=function(){return this.be;};q.getStroke=function(){return this.Pj;};});jsx3.Class.defineClass("jsx3.vector.Shape",jsx3.vector.BaseShape,null,function(k,a){var
ub={a:"d",b:"m",c:"M",d:" ",e:"l",f:"L",g:"A ",h:" 0 ",i:"1",j:"0",k:"z"};var
ga=jsx3.vector;a.getPath=function(){this.Zz();return this.getProperty(ub.a);};a.setPath=function(s){this._p=[s];this.setProperty(ub.a,s);};a.pathMoveTo=function(c,b,m){this.Uw((m?ub.b:ub.c)+ub.d+c+ub.d+b);return this;};a.pathLineTo=function(j,i,s){this.Uw((s?ub.e:ub.f)+ub.d+j+ub.d+i);return this;};a.pathArcTo=function(h,j,b,q,n,e,s,g,o){var
...
G=o?Nb-Lb:Lb-Nb;var
U=G>-1*Math.PI&&G<0||G>Math.PI;(this.pathLineTo(n,e)).Uw(ub.g+b+ub.d+q+ub.h+(U?ub.i:ub.j)+ub.d+(o?ub.i:ub.j)+ub.d+s+ub.d+g);return this;};a.pathClose=function(){this.Uw(ub.k);return this;};a.Uw=function(r){if(!this._p)this._p=[];this._p.push(r);};a.Zz=function(){if(this._p&&this._p.length>1){var
u=this._p.join(ub.d);this.setPath(u);}};a.paintUpdate=function(){this.Zz();this.jsxsuper();};});jsx3.Class.defineClass("jsx3.vector.Line",jsx3.vector.BaseShape,null,function(k,n){var
...
ub={a:"ellipse",b:"cx",c:"number",d:"px",e:"cy",f:"rx",g:"ry",h:"transform",i:"translate(",j:",",k:")"};b.init=function(p,s,d,k){this.jsxsuper(a.dk,p,s,d,k);};a.dk=ub.a;b.getLeft=function(){var
...
G=jsx3.vector;b.init=function(j,q,i,p,l){this.fD=j;this.A4=q;this.zQ=i;this.Bt=p;var
...
R=0;var
mb=Math.sqrt(Math.pow(i-j,2)+Math.pow(p-q,2));if(q>=p){R=360-Math.round(Math.acos((i-j)/mb)*180/Math.PI);}else R=Math.round(Math.acos((i-j)/mb)*180/Math.PI);this.j3=R%360;this.Ny=new
jsx3.html.Text(l);};b.getText=function(){return this.Ny.getText();};b.setText=function(p){this.Ny.setText(p);};b.paintUpdate=function(){if(!this.getProperty(ub.b))if(this.be){this.setProperty(ub.b,this.be.getColorHtml(),ub.c,this.be.getAlpha());}else{var
M=Aa.getStyleClass(ub.d+this.getClassName())||Number(0);if(M&&M.color!=null){this.setProperty(ub.b,M.color);}else this.removeProperty(ub.b,ub.c);}if(this.Pj!=null){var
Pa=this.Pj.getWidth();this.setProperty(ub.e,this.Pj.getColorHtml(),ub.f,Pa||Number(1));}else this.removeProperty(ub.e,ub.f);var
...
T=this.RN;var
zb=this.createCanvas();zb.setId(this.getId());zb.setZIndex(this.getZIndex());zb.setPosition(this.getRelativePosition()?ub.a:ub.b);this.jz(zb);var
Gb=this.getAttributes();for(var Pa in Gb)zb.setProperty(Pa,Gb[Pa]);if(T!=null)T.release();this.RN=zb;return zb;};r.updateVector=function(o){this.applyDynamicProperties();this.jz(o);return true;};r.jz=function(k){var
...
jsx3.gui.Painted.Box(a);};r.Hj=function(f,o,l){if(o){var
...
P=new
L.Oval(k,r,j-k,q-r);P.setFill(l);P.setStroke(h);return P;};i.CROSS=i.jsxclass.newInnerClass();i.CROSS.pT=0.6;i.CROSS.areaToRadius=function(p){return Math.sqrt(p/(1-this.pT/Math.SQRT2))/2;};i.CROSS.render=function(k,r,j,q,l,h){var
rb=j-k;var
mb=this.pT;var
...
gb=this.getAttributes();for(var Aa in gb)Mb.setProperty(Aa,gb[Aa]);if(Ma!=null)Ma.release();if(u!=null)u.replaceChild(Mb,Ma);this._canvas=Mb;};i.getCanvas=function(){if(this._canvas==null)this.updateView();return this._canvas;};i.Ci=function(n){jsx3.chart.Ci(this,n);};if(jsx3.CLASS_LOADER.VML){i.paint=function(){if(this._canvas==null)this.updateView();return this._canvas.paint();};}else if(jsx3.CLASS_LOADER.SVG){i.isDomPaint=function(){return true;};i.paint=function(){throw new
jsx3.Exception();};i.paintDom=function(){if(this._canvas==null)this.updateView();return this._canvas.paintDom();};}i.repaint=function(){this.updateView();return this.jsxsuper();};i.Rf=function(d,o){if(this.E5==null)this.E5={};this.E5[d]=o;};i.md=function(c){return this.E5!=null?this.E5[c]:null;};i.lj=function(a){if(this.E5!=null)delete this.E5[a];};i.getMaskProperties=function(){return s.MASK_PROPS_NOEDIT;};i.getPaddingDimensions=function(){return jsx3.html.BlockTag.Re(this.getPadding());};i.getCanSpy=function(){return true;};s.getVersion=function(){return C.Xe;};});jsx3.require("jsx3.chart.ChartComponent");jsx3.Class.defineClass("jsx3.chart.ChartLabel",jsx3.chart.ChartComponent,null,function(j,p){var
...
Za=this.getFontSize()!=null?this.getFontSize():10;return Math.round(Za*1.5)+(this.isRotated()?ta[1]+ta[3]:ta[0]+ta[2]);};p.getAlpha=function(){return this.alpha;};p.setAlpha=function(r){this.alpha=r!=null?mb.Tb(r):null;};p.getBorderStroke=function(){return this.borderStroke;};p.setBorderStroke=function(f){this.borderStroke=f;};p.getLabelRotation=function(){return this.labelRotation;};p.setLabelRotation=function(m){this.labelRotation=m;};p.isRotated=function(){return this.labelRotation==90||this.labelRotation==270;};p.updateView=function(){this.jsxsuper();var
_=this.getCanvas();var
oa=this.getWidth();var
ta=this.getHeight();var
I=this.getPaddingDimensions();this.Ci();var
W=new
mb.Rectangle(0,0,oa,ta);_.appendChild(W);jsx3.chart.Ud(this,W);var
hb=W.getFill();var
...
O=this.jg();if(k.oQ[this.tickPlacement]&&this.tickLength>0){var
ua=new
...
nb=Jb[0];var
mb=Eb+Jb[1];this.BE(ua,O,mb,nb);}if(k.oQ[this.minorTickPlacement]&&this.minorTickLength>0){var
ja=new
...
Aa=this.Gl(O,lb);this.BE(ja,Aa,mb,nb);fa=O[lb];}if(fa<this.length){var
Aa=this.Gl(O,O.length);this.BE(ja,Aa,mb,nb);}}var
Ya=this._W(Eb);var
...
Mb=Ya[0];var
xa=Ya[1];var
Ga=Ya[2];this._jsxC5=null;for(var
...
jb=xa+Ga*Math.round(k.o4/2);this.Y3(B,D,jb,D+la,jb,this.bL(lb));}else{var
D=Ga==1?xa:xa-la;this.Y3(B,D,Ab,D+la,Ab,this.bL(lb));}}}};q.Y3=function(d,p,s,o,c,b){if(!(b&&(b.toString()).match(ub.t)))return;var
K=new
db.TextLine(p,s,o,c,b);K.setClassName(this.labelClass);K.setExtraStyles(this.labelStyle);K.setColor(this.labelColor);d.appendChild(K);};q.bL=function(j){var
X=this.Li(j);var
xb=this.getLabelFunction();return xb!=null?xb.apply(this,[X,j]):X!=null?X.toString():ub.l;};q.oT=function(){var
Kb=this.tickPlacement==ub.b||this.tickPlacement==ub.c?this.tickLength:0;var
ja=this.minorTickPlacement==ub.b||this.minorTickPlacement==ub.c?this.minorTickLength:0;return Math.max(Kb,ja);};q.Hs=function(c){if(c==null){c=this.getOpposingAxis();if(c==null)return 0;}if(c.fh())return c.getCoordinateFor(0);else if(this.primary)return this.horizontal?c.getLength():0;else return this.horizontal?0:c.getLength();};q.Y7=function(m,o){var
La=0;if(m==ub.c){La=-1*o;o=o*2;}else{var
xa=0;if(this.horizontal)xa++;if(this.primary)xa++;if(m==ub.a)xa++;if(xa%2==1)La=-1*o;}return [o,La];};q._W=function(o){var
...
v=null,ya=null,Ha=null;switch(yb){case k.BX:case k.PJ:ya=-1;v=-this.labelGap;v=v-Math.max(0,K-o);break;case k.mD:case k.YZ:ya=1;v=ab.getLength()+this.labelGap;v=v+Math.max(0,K+o-ab.getLength());break;case k.OS:case k.h2:ya=-1;v=o-this.labelGap-K;break;case k.ZS:case k.F8:ya=1;v=o+this.labelGap+K;break;default:ha.LOG.error(ub.u+yb);}if(this.showLabels){if(this.horizontal)Ha=v+ya*k.o4;else Ha=v+ya*this.getDisplayWidth();}else Ha=v;if(this.horizontal&&this.primary||!this.horizontal&&!this.primary){Ha=Math.max(Ha,ab.getLength());}else Ha=Math.min(Ha,0);return [yb,v,ya,K,u,Ha];};q.sl=function(){var
ra=0,Bb=0;var
...
ta=w[2];var
mb=w[3];var
za=w[4];if(this.showLabels)if(this.horizontal)xb=xb+ta*k.o4;else xb=xb+ta*this.getDisplayWidth();if(xb<0){ra=-xb;}else if(xb>aa.getLength())Bb=xb-aa.getLength();if(za>this.length-F)Bb=Math.max(Bb,za+this.length-F);if(mb>-F)ra=Math.max(ra,mb-F);if(Wa!=null&&Wa.getDisplay()!=jsx3.gui.Block.DISPLAYNONE)if(this.horizontal)Bb=Bb+Wa.getPreferredHeight();else ra=ra+Wa.getPreferredWidth();return [ra,Bb];};q.BE=function(o,r,f,p){if(this.horizontal){for(var
Ha=0;Ha<r.length;Ha++)o.addRelativeLine(r[Ha],f,0,p);}else for(var
Ha=0;Ha<r.length;Ha++)o.addRelativeLine(f,r[Ha],p,0);};q.Jd=function(){return this.jg();};q.Gl=function(f,j){var
...
Va=jsx3.html.BlockTag.Re(this.getMargin());var
y=jsx3.html.BlockTag.Re(this.getPadding());var
...
Ua=new
L.Group(A,U,ka,aa);Nb.appendChild(Ua);Ua.setZIndex(n.IH);if(this.backgroundFill||this.backgroundStroke)if(nb>0||wa!=null&&wa.getDisplay()!=jsx3.gui.Block.DISPLAYNONE){var
ya=new
L.Rectangle(A,U,ka,aa);ya.setZIndex(n.IC);Nb.appendChild(ya);var
ab=L.Fill.valueOf(this.backgroundFill);var
Lb=L.Stroke.valueOf(this.backgroundStroke);ya.setFill(ab);ya.setStroke(Lb);}var
ia=U+y[0];var
da=ka-y[1]-y[3];if(wa!=null&&wa.getDisplay()!=jsx3.gui.Block.DISPLAYNONE){wa.setDimensions(A+y[3],ia,da,wa.getPreferredHeight());wa.setZIndex(n.TE);wa.updateView();Nb.appendChild(wa.getCanvas());ia=ia+Ha;}ia=ia-U;var
...
hb=this.ZM(Ua,ob[Ib].getSeriesName(),this.labelClass,this.labelStyle,O,Math.round(ia+this.boxHeight/2),ra);ia=ia+this.lineHeight;this.Ci(Z,ob[Ib],null);this.Ci(hb,ob[Ib],null);}}else if(Da==2&&nb>0){var
Xa=Ba.bh();var
...
hb=this.ZM(Ua,Ra,this.labelClass,this.labelStyle,O,Math.round(ia+this.boxHeight/2),ra);ia=ia+this.lineHeight;this.Ci(Z,null,Ib);this.Ci(hb,null,Ib);}}};q.ZM=function(r,d,b,h,c,f,o){var
db=new
L.TextLine(c,f,o,f,d);db.setClassName(b);db.setExtraStyles(h);if(!db.getTextAlign())db.setTextAlign(ub.e);r.appendChild(db);return db;};q.getLegendTitle=function(){return Sa.ChartLabel?this.getFirstChildOfType(Sa.ChartLabel):null;};q.onSetChild=function(o){return (Sa.ChartLabel&&o instanceof Sa.ChartLabel)&&this.getLegendTitle()==null;};q.onSetParent=function(f){return Sa.Chart&&f instanceof Sa.Chart;};n.getVersion=function(){return Sa.Xe;};q.Ci=function(i,c,a){if(i==null)i=this.getCanvas();if(c!=null)i.setProperty(ub.f,c.getId());if(a!=null)i.setProperty(ub.g,a);this.jsxsuper(i);};q.nj=function(l,a){var
pb=a.getAttribute(ub.f);var
v=a.getAttribute(ub.g);this.doEvent(jsx3.gui.Interactive.SELECT,this.N8(l,pb,v));};q.Xj=function(j,c){var
...
Na=i.getAttribute(ub.g);this.jsxsupermix(p,i,this.N8(p,mb,Na));};q.yo=function(d,i){var
...
Ua=this.getChart();if(Ua!=null)return this.usePrimaryY?Ua.getPrimaryYAxis():Ua.getSecondaryYAxis();return null;};p.of=function(){var
...
D=this.of();T.Chart.DEFAULT_STROKES[vb]=new
Ab.Stroke(D.getColor(),1,D.getAlpha());}return T.Chart.DEFAULT_STROKES[vb];};p.Gk=function(){var
xb=this.fill?Ab.Fill.valueOf(this.fill):this.of();if(xb!=null)xb=T.addGradient(xb,this.fillGradient);return xb;};p.Sb=function(d){if(this.stroke){return Ab.Stroke.valueOf(this.stroke);}else if(this.getColorFunction()!=null){return null;}else if(d!=null&&d.Aj()){return new
Ab.Stroke(d.getColor());}else if(!this.fill)return this.gd(d);else return null;};p.getColorFunction=function(){return T.Ul(this,ub.b);};p.setColorFunction=function(o){T.yd(this,ub.b,o);};p.getLegendRenderer=function(){return T.PointRenderer.BOX;};p.getLabel=function(){return T.ChartLabel?this.getFirstChildOfType(T.ChartLabel):null;};p.onSetChild=function(b){return (T.ChartLabel&&b instanceof T.ChartLabel)&&this.getLabel()==null;};p.onSetParent=function(s){return T.Chart&&s instanceof T.Chart;};p.Ci=function(a,i,h){if(a==null)a=this.getCanvas();if(h!=null)a.setProperty(ub.c,h);if(i!=null)a.setProperty(ub.d,i);this.jsxsuper(a);};p.nj=function(d,i){var
Aa=i.getAttribute(ub.d);var
yb=i.getAttribute(ub.c);this.doEvent(jsx3.gui.Interactive.SELECT,{objEVENT:d,intINDEX:Aa,strRECORDID:yb});};p.Xj=function(c,j){var
...
sb=e.getAttribute(ub.c);this.jsxsupermix(h,e,{objEVENT:h,intINDEX:ka,strRECORDID:sb});};p.yo=function(s,j){var
...
u=this.doEvent(da.MENU,Cb);if(u!==false){if(u instanceof Object&&u.objMENU instanceof jsx3.gui.Menu)mb=u.objMENU;mb.showContextMenu(s,this,V);}}}};m.getVersion=function(){return T.Xe;};});jsx3.require("jsx3.vector.Block","jsx3.xml.Cacheable","jsx3.chart.Series");jsx3.Class.defineClass("jsx3.chart.Chart",jsx3.vector.Block,[jsx3.xml.Cacheable,jsx3.xml.CDF],function(d,f){var
...
_=jsx3.vector;var
lb=_.Fill;var
M=jsx3.chart;d.g9=1;d.C8=2;d.ZINDEX_DATA=10;d.Vr=990;d.hC=1000;d.LB=20;d.DEFAULT_FILLS=[new
lb(3381708,1),new
lb(16763904,1),new
lb(10079334,1),new
lb(13408563,1),new
...
jsx3.IllegalArgumentException(ub.e,l);};f.getDataPadding=function(){return this.dataPadding;};f.setDataPadding=function(a){this.dataPadding=a;};f.getBorderColor=function(){return this.borderColor;};f.setBorderColor=function(l){this.borderColor=l;};f.getBorderWidth=function(){return this.borderWidth;};f.setBorderWidth=function(h){this.borderWidth=h;};f.getBorderAlpha=function(){return this.borderAlpha;};f.setBorderAlpha=function(m){this.borderAlpha=m;};f.getAlpha=function(){return this.alpha;};f.setAlpha=function(o){this.alpha=o!=null?_.Tb(o):null;};f.wf=function(){return this._jsxdc;};f.bh=function(){return this._jsxdp;};f.Pw=function(e){if(e!=null){this._jsxdp=(e.selectNodes(ub.f)).toArray();}else delete this[ub.g];};f.getSeries=function(){return this.getDescendantsOfType(M.Series);};f.zf=function(){return this.findDescendants(function(s){return s instanceof M.Series&&s.getDisplay()!=jsx3.gui.Block.DISPLAYNONE;},false,true,false,false);};f.getSeriesIndex=function(o){var
...
oa=q[fb][h](bb[ga]);if(oa!=null)Ka[ga]+=Math.abs(oa);}}return Ka;};f.Xd=function(o,j,h){var
...
Mb=new
_.Rectangle(0,0,Ma,zb);ua.appendChild(Mb);Mb.setZIndex(d.g9);M.Ud(this,Mb);M._h(this,Mb);var
Ab=jsx3.html.BlockTag.Re(this.getPadding());var
Pa=this.borderWidth!=null?this.borderWidth:1;Ma=Ma-Ab[1]-Ab[3]-2*Pa;zb=zb-Ab[0]-Ab[2]-2*Pa;var
ra=new
_.Group(Ab[3]+Pa,Ab[0]+Pa,Ma,zb);ua.appendChild(ra);ra.setZIndex(d.C8);var
...
vb=M.splitBox(sb,pb,Ma,zb,this.legendPlacement,U.getPreferredWidth(),U.getPreferredHeight());U.setDimensions(vb[0][0],vb[0][1],vb[0][2],vb[0][3]);U.setZIndex(d.Vr);U.updateView();ra.appendChild(U.getCanvas());G.setDimensions(vb[1][0],vb[1][1],vb[1][2],vb[1][3]);}else G.setDimensions(sb,pb,Ma,zb);var
mb=jsx3.html.BlockTag.Re(this.dataPadding);var
Ra=G.getDimensions();G.setDimensions(Ra[0]+mb[3],Ra[1]+mb[0],Ra[2]-mb[1]-mb[3],Ra[3]-mb[0]-mb[2]);M.Ci(this);var
u=this.zf();for(var
za=0;za<u.length;za++){var
Ba=this.kg()?u.length-za:za;u[za].setZIndex(d.LB+Ba);}return ua;};f.updateVector=function(q){return false;};f.repaintParts=function(a){if(a&d.PART_LEGEND){var
xb=this.getLegend();if(xb!=null)xb.repaint();}};f.onSetChild=function(n){if(M.Legend&&n instanceof M.Legend){if(this.getLegend()!=null){M.LOG.info(ub.j+n+ub.k);return false;}}else if(M.ChartLabel&&n instanceof M.ChartLabel){if(this.getChartTitle()!=null){M.LOG.info(ub.l+n+ub.m);return false;}}else if(M.Series&&n instanceof M.Series){if(!this.rl(n)){M.LOG.info(ub.n+n+ub.o+this);return false;}}else return false;return true;};f.redrawRecord=function(){this.repaint();};f.onXmlBinding=function(j){this.jsxsupermix(j);this.repaint();};d.getVersion=function(){return M.Xe;};});jsx3.require("jsx3.chart.Chart","jsx3.chart.Axis","jsx3.chart.GridLines");jsx3.Class.defineClass("jsx3.chart.CartesianChart",jsx3.chart.Chart,null,function(g,b){var
ub={a:"series",b:"no data provider for chart: "};var
va=jsx3.chart;var
Za=va.Chart;var
Ta=va.GridLines;var
qa=va.Axis;g.oz=function(k){return k instanceof qa&&k.uf()&&k.getHorizontal();};g.Es=function(e){return e instanceof qa&&!e.uf()&&e.getHorizontal();};g.TM=function(l){return l instanceof qa&&l.uf()&&!l.getHorizontal();};g.PE=function(q){return q instanceof qa&&!q.uf()&&!q.getHorizontal();};g.Rz=Za.ZINDEX_DATA+1;g.pU=Za.ZINDEX_DATA+90;g.PT=Za.ZINDEX_DATA+100;g.PART_GRIDLINES=1<<8;b.init=function(l,p,s,d,a){this.jsxsuper(l,p,s,d,a);};b.getGridLines=function(){return Ta?this.getDescendantsOfType(Ta):[];};b.pe=function(h,q){var
v=[];var
gb=q?this.zf():this.getSeries();for(var
F=0;F<gb.length;F++)if(h.getHorizontal()&&h.uf()==gb[F].getUsePrimaryX()||!h.getHorizontal()&&h.uf()==gb[F].getUsePrimaryY())v.push(gb[F]);return v;};b.getPrimaryXAxis=function(){return this.findDescendants(g.oz,false,false,true);};b.getSecondaryXAxis=function(){return this.findDescendants(g.Es,false,false,true);};b.getPrimaryYAxis=function(){return this.findDescendants(g.TM,false,false,true);};b.getSecondaryYAxis=function(){return this.findDescendants(g.PE,false,false,true);};b.getRangeForAxis=function(c){var
...
D=null;for(var
ja=1;ja<=2;ja++){var
Mb=null;if(ja==1){Mb=[V!=null?V.getDisplayWidth():0,F!=null?F.getDisplayWidth():0,X!=null?X.getDisplayWidth():0,Ya!=null?Ya.getDisplayWidth():0];}else Mb=this.G7(V,F,X,Ya);D=[S[3]+Mb[3],S[0]+Mb[0],Na-(S[3]+Mb[3]+S[1]+Mb[1]),Oa-(S[0]+Mb[0]+S[2]+Mb[2])];this.bR(X,D[2]);this.bR(Ya,D[3]);this.bR(V,D[2]);this.bR(F,D[3]);}var
ba=this.getGridLines();for(var
ja=0;ja<ba.length;ja++){var
Hb=ba[ja];if(Hb.getDisplay()==jsx3.gui.Block.DISPLAYNONE)continue;Hb.setDimensions(D);Hb.setZIndex(Hb.getInForeground()?g.pU:g.Rz);Hb.updateView();Nb.appendChild(Hb.getCanvas());}this.z3(X,D[0],D[1]);this.z3(Ya,D[0],D[1]);this.z3(V,D[0],D[1]);this.z3(F,D[0],D[1]);var
E=this.zf();for(var
ja=0;ja<E.length;ja++)E[ja].setDimensions(D);};b.bR=function(l,k){if(l!=null){l.setLength(k);l.vd();}};b.z3=function(q,i,j){var
kb=this.wf();if(q!=null){q.setDimensions(i,j,kb.getWidth(),kb.getHeight());q.setZIndex(g.PT);q.updateView();kb.appendChild(q.getCanvas());}};b.G7=function(e,q,k,r){var
da=0,bb=0,ca=0,za=0;if(e!=null){var
oa=e.sl();bb=oa[1];za=oa[0];}if(q!=null){var
oa=q.sl();ca=ca+oa[0];da=da+oa[1];}if(k!=null){var
oa=k.sl();za=Math.max(za,oa[1]);bb=Math.max(bb,oa[0]);}if(r!=null){var
oa=r.sl();da=Math.max(da,oa[0]);ca=Math.max(ca,oa[1]);}return [bb,ca,za,da];};b.repaintParts=function(m){if(m&g.PART_GRIDLINES){var
Ja=this.getGridLines();for(var
pa=0;pa<Ja.length;pa++){var
S=Ja[pa];if(S.getDisplay()==jsx3.gui.Block.DISPLAYNONE)continue;S.setZIndex(S.getInForeground()?g.pU:g.Rz);S.repaint();}}this.jsxsuper(m);};b.onSetChild=function(a){if(Ta&&a instanceof Ta){return true;}else if(qa&&a instanceof qa){return true;}else return this.jsxsuper(a);};g.getVersion=function(){return va.Xe;};});